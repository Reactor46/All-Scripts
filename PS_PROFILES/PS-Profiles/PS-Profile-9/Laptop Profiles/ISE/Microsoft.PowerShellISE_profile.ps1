...
# NOTE: This profile will affect all users with Powershell ISE instances.
...
# cp -Path C:\Users\Noah\repos\WindowsPowerShell\Microsoft.PowerShellISE_profile.ps1 -Destination C:\Windows\System32\WindowsPowerShell\v1.0
...
# This script was found here: http://blog.danskingdom.com/powershell-ise-multiline-comment-and-uncomment-done-right-and-other-ise-gui-must-haves/
...
# Set-Location C:\Users\Noah

# Importing the Powershell Community Extension module.
# Import-Module PSCX

# This makes it possible to interpret python scripts without using the
# [python [file name]] command.
# $env:PATHEXT += ";.py"
...
# Testing or debugging module for colour settings.

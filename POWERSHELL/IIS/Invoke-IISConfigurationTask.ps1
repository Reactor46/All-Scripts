...
Function Invoke-IISConfigurationTask {
    ...
    try {
        ...
        WriteTaskInfo -MessageData "[Setting] $Key => $value" -Tag $SiteName
        ...
        Write-Verbose "Updating IIS configuration"
        Write-Verbose "Updating $ConfigPath : $Key => $Value"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUGx7K3/nMkMrB3VdLErkUodgQ
# Z6ygghL8MIID7jCCA1egAwIBAgIQfpPr+3zGTlnqS5p31Ab8OzANBgkqhkiG9w0B
...
# MAwGCisGAQQBgjcCARUwIwYJKoZIhvcNAQkEMRYEFDciFXDRi6FaOW8J1PD1ypdh
# Ko2OMA0GCSqGSIb3DQEBAQUABIIBAFKpdWYeVP1GMv5h3tupZJvgU/8ROyJNU6dB
# Gw/TmCH4RAyWgB31tyhdLhD9yDtS4ktO9+DN5RF82eDkJ08XrOFQazSN/ttbHE4M
# XOl/fHgHSYE+nD+EMQbm7c83ASn9juurqJvD8IJm06IPiw6uzh3G/8VxITsNMzPD
# eoN2A/lVzB92WChi1qgj2SlJEby9+EhF0v1QYovPy6rAffTJGaztmr9Z3kWWof+X
# IjOJj3OA5N94j7088lcxqFvnTLyenZzO3b4tBIgTayQPiMtUPwrFszfDgVLGDfY4
# EpYNYvPydEwz+lLPxtqa7Ew3WzzMNYrIBcEQZ1L4TdXkXAq89IihggILMIICBwYJ
...
# MjAwNjI1MjEyNzA5WjAjBgkqhkiG9w0BCQQxFgQUxJNRI1CdD3/GTzJ5TqIUwwIE
# tJ4wDQYJKoZIhvcNAQEBBQAEggEAYSaswYOvmrAYig5PY6DYcZkgcEwPiQH3R2gB
# Y/lVS5NlUeUGtG92QSgDNAtIyXTS0tMO0+UMYMCFL7F9Ain4Xd+2fkUXlnzWW3+M
# i8CPn7iSVo/k9+zAEq/4+D3D3tJ875EjgOp59eFH173TBFdH6HC4UG+qYqQs52Xl
# 7xSK92Vik9lPBWqBjbUrYQw2LDQbFndhASUgFOsWkrZlWJlzw7RsunuZ34U+KdPc
# m6kzbHpFNZDAXsJmrFf9eVjLM0gjfBeEZzUQxudKz8OCpg4OWd76dlhZXgVnrdUe
# VyMi988J/M5WZk0cHe7pvGsrcq0YYT/Co8r27LXttJEExumrzw==

...
{
	return Get-WebConfiguration system.applicationHost/applicationPools/workerProcesses/* |
     Select-Object -Property @{Name="ApplicationPoolName"; Expression={$_.appPoolName}}, @{Name="PID"; Expression={$_.ProcessId}}
}

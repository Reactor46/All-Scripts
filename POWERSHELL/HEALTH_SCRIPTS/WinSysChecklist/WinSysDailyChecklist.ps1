...
$timeout = "60"
$AllSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\Servers.txt"
$BatProc = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\BatProcSrvs.txt"
$CapsMTSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\CapsMTSrvs.txt"
$CapsSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\CapsSrvs.txt"
$CASMTSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\CASMTSrvs.txt"
$CASSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\CASSrvs.txt"
$CollSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\CollSrvs.txt"
$DCSrvs = Get-Content -Path "C:\LazyWinAdmin\WinSysChecklist\Configs\DCSrvs.txt"
$npt = $DCSrvs

...
[array]$Servers = "LASMT01,LASMT02,LASMT03".Split(","),
[int]$InstanceLimit=3,
[int]$LoopMax = 2,
...
[Parameter(Mandatory=$true,Position=1)]$aObject)
    ...
    foreach($srvObj in $aObject){
        foreach($CounterDataObject in $srvObj.CounterData){
            ...
            "DeepGreaterThanThresholdCheck" {Write-Verbose "Working on server $srvObj. It was selected for DeepGreaterThanThresholdCheck"; Detect-Issue DeepGtThresholdCheck $CounterDataObject}
            "NormalGreaterThanThresholdCheck" {Write-Verbose "Working on server $srvObj. It was selected for NormalGreaterThanThresholdCheck"; Detect-Issue NormalGtThresholdCheck $CounterDataObject}
            "NormalLessThanThresholdCheck" {Write-Verbose "Working on server $srvObj. It was selected for NormalLessThanThresholdCheck"; Detect-Issue NormalLessThanThresholdCheck $CounterDataObject}

...
# describes the function CheckTime
Describe 'CheckTime' {
  ...
  Context 'Running without arguments'   {
    ...
    It 'runs without errors' {
      ...
      # scriptblock (braces):
      { CheckTime } | Should Not Throw
    }
    It 'does something' {
      # call function CheckTime and pipe the result to an assertion
      # Example:
      # CheckTime | Should Be 'Expected Output'
      # Hint: 
    ...
    It 'does not return anything'     {
      CheckTime | Should BeNullOrEmpty 
    }
  }
}

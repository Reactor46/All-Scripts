...
# 
# NAME: Server/Workstation Inventory (CompInv_v2.1.ps1)
# 
# ORIGINAL_AUTHOR: Jesse Hamrick
# EDITED_AUTHOR: John Battista
# DATE  : 2/25/2009
# Update: 1/22/2015 for Excel 2007/2010/2013
# Edited: 4/26/2017 
...
foreach ($StrComputer in $colComputers){
        ...
        $VideoItems = gwmi Win32_VideoController -Comp $StrComputer
...
#Populate Video Sheet
	foreach ($objItem in $VideoItems){
		$Sheet6.Cells.Item($intRowVideo, 1) = $StrComputer
        $Sheet6.Cells.Item($intRowVideo, 2) = $objItem.VideoProcessor
		$Sheet6.Cells.Item($intRowVideo, 3) = $objItem.Description
		$Sheet6.Cells.Item($intRowVideo, 4) = $objItem.AdapterRam/1024/1024
		$Sheet6.Cells.Item($intRowVideo, 5) = $objItem.DeviceID
        $intRowVideo = $intRowVideo + 1
		}
		
#Populate Network Sheet
	foreach ($objItem in $NetItems){
		$Sheet7.Cells.Item($intRowNet, 1) = $StrComputer
		$Sheet7.Cells.Item($intRowNet, 2) = $objItem.Caption+" (enabled)"
		$Sheet7.Cells.Item($intRowNet, 3) = $objItem.DHCPEnabled
		$Sheet7.Cells.Item($intRowNet, 4) = $objItem.IPAddress
		$Sheet7.Cells.Item($intRowNet, 5) = $objItem.IPSubnet
		$Sheet7.Cells.Item($intRowNet, 6) = $objItem.DefaultIPGateway
		$Sheet7.Cells.Item($intRowNet, 7) = $objItem.DNSServerSearchOrder
		$Sheet7.Cells.Item($intRowNet, 8) = $objItem.FullDNSRegistrationEnabled
		$Sheet7.Cells.Item($intRowNet, 9) = $objItem.WINSPrimaryServer
		$Sheet7.Cells.Item($intRowNet, 10) = $objItem.WINSSecondaryServer
		$Sheet7.Cells.Item($intRowNet, 11) = $objItem.WINSEnableLMHostsLookup
...
foreach ($StrComputer in $colComputers){
        ...
        $VideoItems = gwmi Win32_VideoController -Comp $StrComputer -Credential $cred
		$NetItems = gwmi Win32_NetworkAdapterConfiguration -Comp $StrComputer -Credential $cred | where{$_.IPEnabled -eq "True"}
...
#Create Heading for Video Sheet
$Sheet6.Cells.Item(1,1) = "Device_Name"
$Sheet6.Cells.Item(1,2) = "Video_Processor"
$Sheet6.Cells.Item(1,3) = "Description"
$Sheet6.Cells.Item(1,4) = "Video_Ram"
$Sheet6.Cells.Item(1,5) = "Video Card #"

#Create Heading for Network Sheet
$Sheet7.Cells.Item(1,1) = "Device_Name"
$Sheet7.Cells.Item(1,2) = "Network_Card"
$Sheet7.Cells.Item(1,3) = "DHCP_Enabled"
$Sheet7.Cells.Item(1,4) = "IP_Address"
$Sheet7.Cells.Item(1,5) = "Subnet_Mask"
$Sheet7.Cells.Item(1,6) = "Default_Gateway"
$Sheet7.Cells.Item(1,7) = "DNS_Servers"
$Sheet7.Cells.Item(1,8) = "DNS_Reg"
$Sheet7.Cells.Item(1,9) = "Primary_WINS"
$Sheet7.Cells.Item(1,10) = "Secondary_WINS"
$Sheet7.Cells.Item(1,11) = "WINS_Lookup"

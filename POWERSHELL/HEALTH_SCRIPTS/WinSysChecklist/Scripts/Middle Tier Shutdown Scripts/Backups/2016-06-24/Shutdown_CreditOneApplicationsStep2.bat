...
cscript.exe SvcManager.vbs Contosocorp LASSVC01 ContosoCheckRequestService stop 10
cscript.exe SvcManager.vbs Contosocorp LASSVC01 ContosoLPSService stop 10
cscript.exe SvcManager.vbs Contosocorp LASSVC04 CentralizedCacheService stop 15

cscript.exe SvcManager.vbs Contosocorp LASSVC02 CollectionsAgentTimeService stop 10
cscript.exe SvcManager.vbs Contosocorp LASSVC02 ContosoCheckRequestService stop 10
cscript.exe SvcManager.vbs Contosocorp LASSVC02 ContosoLPSService stop 10

cscript.exe SvcManager.vbs Contosocorp LASSVC04 CollectionsAgentTimeService stop 10
cscript.exe SvcManager.vbs Contosocorp LASSVC04 ContosoCheckRequestService stop 10
cscript.exe SvcManager.vbs Contosocorp LASSVC04 ContosoLPSService stop 10
...
rem cscript.exe SvcManager.vbs Contosocorp LASSVC04 CentralizedCacheService stop 15 to be unremmed soon.

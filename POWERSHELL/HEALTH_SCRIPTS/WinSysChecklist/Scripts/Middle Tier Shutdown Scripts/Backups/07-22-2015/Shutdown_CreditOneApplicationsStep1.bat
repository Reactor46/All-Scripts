...
cscript.exe SvcManager.vbs Contosocorp LASCAS06 W3SVC stop 300
cscript.exe SvcManager.vbs Contosocorp LASCAS07 W3SVC stop 300
cscript.exe SvcManager.vbs Contosocorp LASCAS08 W3SVC stop 300
...
cscript.exe SvcManager.vbs Contosocorp LASCAPS05 W3SVC stop 300
cscript.exe SvcManager.vbs Contosocorp LASCAPS06 W3SVC stop 300

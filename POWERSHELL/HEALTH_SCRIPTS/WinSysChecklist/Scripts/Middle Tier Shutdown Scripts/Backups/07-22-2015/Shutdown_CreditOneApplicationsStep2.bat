...
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 ContosoApplicationParsingService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 ContosoApplicationImportService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 NetConnectTransactionsSavingService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 ContosoDebitCardHolderFileWatcher stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 FromPPSExchangeFileWatcherService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 ContosoIdentityCheckService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 BoardingService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 ContosoApplicationProcessingService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 ContosoIPFraudCheckService stop 15
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT01-1 CreditPullService stop 15
...
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT05 NetConnectTransactionsSavingService stop 15
...
cscript.exe SvcManager.vbs Contosocorp LASCAPSMT05 BoardingService stop 15

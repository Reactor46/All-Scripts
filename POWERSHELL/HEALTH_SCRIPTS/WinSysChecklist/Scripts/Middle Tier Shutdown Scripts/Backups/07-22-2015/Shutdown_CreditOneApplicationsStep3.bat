...
cscript.exe SvcManager.vbs Contosocorp LASCASMT08 W3SVC stop 300
cscript.exe SvcManager.vbs Contosocorp LASCASMT09 W3SVC stop 300
cscript.exe SvcManager.vbs Contosocorp LASCASMT10 W3SVC stop 300
...
cscript.exe SvcManager.vbs Contosocorp LASCASMT08 ContosoDataLayerService stop 10
cscript.exe SvcManager.vbs Contosocorp LASCASMT09 ContosoDataLayerService stop 10
cscript.exe SvcManager.vbs Contosocorp LASCASMT10 ContosoDataLayerService stop 10
...
cscript.exe SvcManager.vbs Contosocorp LASMT06 ContosoDataLayerService stop 10
...
cscript.exe SvcManager.vbs Contosocorp LASSVC03 ContosoCheckRequestService stop 15
cscript.exe SvcManager.vbs Contosocorp LASSVC03 ContosoLPSService stop 15
cscript.exe SvcManager.vbs Contosocorp LASSVC03 CentralizedCacheService stop 10

cscript.exe SvcManager.vbs Contosocorp LASSVC04 ContosoCheckRequestService stop 15
cscript.exe SvcManager.vbs Contosocorp LASSVC04 ContosoLPSService stop 15
cscript.exe SvcManager.vbs Contosocorp LASSVC04 CentralizedCacheService stop 10

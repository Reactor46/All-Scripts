...
cscript.exe SvcManager.vbs Contosocorp LASSVC02 FdrOutGoingFileWatcher start 10
cscript.exe SvcManager.vbs Contosocorp LASSVC02 ValidationTriggerWatcher start 10

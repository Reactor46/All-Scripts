...
if ($Choice -eq "YES") 
{
 ...
 Append-T1P -text " "
 Append-T1P -text "### Shutting down CreditEngine service on LASMERIT servers ###" -color orange
 
 $servermerits = "lasmerit01" , "lasmerit02"
...
Append-T1P -text " "
 ...
 $servergroups = "lascasmt01" , "lascasmt02" , "lascasmt03" , "lascasmt04" , "lascasmt05" , "lascasmt06" , "lascasmt07" , "lascasmt08" , "lascasmt09" , "lascasmt10" , "lascoll01" , "lascoll02" , "lascoll03" , "lascoll04" , "lascoll05" , "lascoll06" , "lascoll07" , "lascoll08" , "lascoll09", "lasmt01" , "lasmt02" , "lasmt03" , "lasmt04" , "lasmt05" , "lasmt06" , "lasmt07" , "lasmt08" , "lasmt09" , "lasmt10"
...
#As Seen on \\lasinfra02\InfraSupport\Middle Tier Shutdown Scripts
 ...
 Append-T1P -text " "
 Append-T1P -text "### Validating the CreditEngine service on LASMERIT servers ###" -color orange
 Append-T1E -text " "
 Append-T1E -text "### Validating the CreditEngine service on LASMERIT servers ###" -color orange
...
$serversvcs = "lassvc04"
 ...
 $servergroups = "lascasmt01" , "lascasmt02" , "lascasmt03" , "lascasmt04" , "lascasmt05" , "lascasmt06" , "lascasmt07" , "lascasmt08" , "lascasmt09" , "lascasmt10" , "lascoll01" , "lascoll02" , "lascoll03" , "lascoll04" , "lascoll05" , "lascoll06" , "lascoll07" , "lascoll08" , "lascoll09", "lasmt02" , "lasmt03" , "lasmt05" , "lasmt06" , "lasmt07" , "lasmt08" , "lasmt09" , "lasmt10"
 foreach ($servergroup in $servergroups)
    {
     $Online = Test-Connection -ComputerName $servergroup -Count 1 -Quiet
      if ($Online -eq $True)
...
#StartUp_CreditOneApplicationsStep2.bat
 Append-T2P -text " "
 Append-T2P -text "### Starting the CreditEngine service on LASMERIT servers ###" -color orange
 Append-T2E -text " "
 Append-T2E -text "### Starting the CreditEngine service on LASMERIT servers ###" -color orange
$servermerits = "lasmerit01" , "lasmerit02"
 foreach ($servermerit in $servermerits)
    {
     $Online = Test-Connection -ComputerName $servermerit -Count 1 -Quiet
...
#StartUp_CreditOneApplicationsStep2.bat
 Append-T2P -text " "
 Append-T2P -text "### Validating the CreditEngine service on LASMERIT servers ###" -color orange
 Append-T2E -text " "
 Append-T2E -text "### Validating the CreditEngine service on LASMERIT servers ###" -color orange
 $servermerits = "lasmerit01" , "lasmerit02"
 foreach ($servermerit in $servermerits)
    {
     $Online = Test-Connection -ComputerName $servermerit -Count 1 -Quiet

...
bResult =  CheckMultipleServices( "LASSVC02", "", "CollectionsAgentTimeService;CreditOne.LogParser.Service;CreditOneBatchLetterRequestService;ContosoFinCenService;ContosoQueueProcessorService;CentralizedCacheService;ContosoCheckRequestService;ContosoLPSService" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASRFAX01", "", "RFALERT;RFDB;RFDOCTRANS;RFEDCPARENTNOTIFY1;RFEDCCONV1;RFEDCFCOPY1;RFEDCGIMG1;RFEDCGENPCL1;RFEDCGTEXT1;RFEDCLOOKUP1;RFEDCMGR;RFEDCPARENTMON1;RFEDCRFSEND1;RFEDCRFSENDSTAT1;RFEMAIL;RFMIME;RFPAGE;RFQUEUE;RFRemote;RFRPC;RFSERVER;RFWORK1;RFWORK2;RFWORK3" )
WScript.Echo SYSEXPLANATION

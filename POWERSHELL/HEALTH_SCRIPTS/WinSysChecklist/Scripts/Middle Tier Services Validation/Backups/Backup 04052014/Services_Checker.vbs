...
WScript.Echo "ContosoFinCenService should only be running either LASSVC01 or LASSVC02, whichever one is active in the F5" & vbCrLF

bResult =  CheckMultipleServices( "LASSVC01", "", "CollectionsAgentTimeService;CreditOne.LogParser.Service;CreditOneBatchLetterRequestService;ContosoFinCenService;ContosoQueueProcessorService;CentralizedCacheService;ContosoCheckRequestService;ContosoLPSService" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASSVC02", "", "CollectionsAgentTimeService;ContosoFinCenService;CentralizedCacheService;ContosoCheckRequestService;ContosoLPSService" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASMERIT01", "", "CreditEngine" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASMERIT02", "", "CreditEngine" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASCAPSMT01", "", "CreditPullService;ContosoIPFraudCheckService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoApplicationImportService" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCAPSMT02", "", "CreditPullService;ContosoIPFraudCheckService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoDebitCardHolderFileWatcher;FromPPSExchangeFileWatcherService;ContosoApplicationImportService;ContosoApplicationParsingService" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCAPSMT03", "", "CreditPullService;ContosoIPFraudCheckService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoApplicationImportService" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCAPSMT04", "", "CreditPullService;ContosoIPFraudCheckService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoApplicationImportService" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASCAPS03", "", "W3SVC" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCAPS04", "", "W3SVC" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASPROCDB01", "", "MSSQLSERVER;SQLSERVERAGENT" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASPROCAPP01", "", "G360PA-DOC_LINK;G360PA-WFSERVE;G360PA-WFSERVE2;G360PA-WFSERVEARCHIVE;G360PA-WFSERVEIMPORT" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASPROCAPP02", "", "Service1" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASCODE01", "", "JIRA061008111809" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCODE02", "", "AccuRev Server;AccuRev DB Server;AccuRev RLM" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASITS01", "", "qserver;SQLANYs_sem5;SepMasterService;semsrv;semwebsrv;SmcService;ScanExplicit" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASPRINT02", "", "Spooler" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASTI01", "", "TIServiceManagement" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASINFRA02", "", "ADReports" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASURCHIN01", "", "Urchin6CPCScheduler;Urchin6MasterScheduler;Urchin6SlaveScheduler;Urchin6Webserver" )
WScript.Echo SYSEXPLANATION

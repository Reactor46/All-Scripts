...
'FdrOutGoingFileWatcher and ValidationTriggerWatcher should only be installed and running on LASSVC02
bResult =  CheckMultipleServices( "LASSVC02", "", "CollectionsAgentTimeService;ContosoFinCenService;CentralizedCacheService;ContosoCheckRequestService;ContosoLPSService;FdrOutGoingFileWatcher;ValidationTriggerWatcher" )
WScript.Echo SYSEXPLANATION

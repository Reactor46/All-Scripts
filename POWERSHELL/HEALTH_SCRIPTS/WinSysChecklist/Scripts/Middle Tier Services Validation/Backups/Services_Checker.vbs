...
bResult =  CheckMultipleServices( "LASSVC04", "", "CreditOneBatchLetterRequestService;CreditOne.LogParser.Service;ContosoQueueProcessorService;CollectionsAgentTimeService;ContosoCheckRequestService;ContosoLPSService;fdrOutGoingFileWatcher;ValidationTriggerWatcher;ContosoFinCenService" )
WScript.Echo SYSEXPLANATION

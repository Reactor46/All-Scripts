...
bResult =  CheckMultipleServices( "LASSVC01", "", "CollectionsAgentTimeService;ContosoCheckRequestService;ContosoLPSService;CentralizedCacheService" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASSVC04", "", "CreditOneBatchLetterRequestService;CreditOne.LogParser.Service;ContosoQueueProcessorService;CollectionsAgentTimeService;ContosoCheckRequestService;ContosoLPSService;fdrOutGoingFileWatcher;ValidationTriggerWatcher;ContosoSinCenService" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASCAPSMT05", "", "CreditPullService;ContosoIPFraudCheckService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoApplicationImportService" )
WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCAPSMT06", "", "CreditPullService;ContosoIPFraudCheckService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoApplicationImportService" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASINFRA01", "", "SchedulerService" )
WScript.Echo SYSEXPLANATION
...
bResult =  CheckMultipleServices( "LASSVC02", "", "ContosoCheckRequestService;ContosoLPSService;CollectionsAgentTimeService" )
WScript.Echo SYSEXPLANATION

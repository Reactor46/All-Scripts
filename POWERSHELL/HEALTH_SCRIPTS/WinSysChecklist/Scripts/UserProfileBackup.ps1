...
[void][System.Reflection.Assembly]::LoadWithPartialName('Microsoft.VisualBasic')
$Destination = [Microsoft.VisualBasic.Interaction]::InputBox('Enter the desitnation path UNC', 'Export Windows Profile')

#Defining Remote Paths
###################################################################################################################
#$Destination = "$Desination\$Profile" # "\\SERVER\BACKUP\" # "Enter Destination Folder Here"

...
$Hotfix=(get-hotfix | sort installedon)|select -last 50 HotFixID,InstalledBy,InstalledOn,Description|ConvertTo-Html
...
$out | Select-Object  Name, Status, NextRuNTime, LastRunTime, LastRunResult, Author, Created | ConvertTo-Html >D:\ps\Scripts\task-sceduler.html
...
$Outputreport += "</table></BODY></HTML>"
$Outputreport | out-file D:\ps\Scripts\Windows_Server_Health_Status.html
Invoke-Expression D:\ps\Scripts\Windows_Server_Health_Status.html

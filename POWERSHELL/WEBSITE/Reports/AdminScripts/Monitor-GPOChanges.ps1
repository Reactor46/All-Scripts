...
$PlaceToCopyFullReport = "C:\inetpub\wwwroot\Reports\" # if this is blank, it will be ignored
$global:smtpServer = "lasexch01.Contoso.corp"
...
$HTMLoutputpath = 'C:\inetpub\wwwroot\Reports\GPOMonitor\HTML'
$HTMLHEADERoutputfilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\HTML\HTMLHEADERGPOEvents.htm"
$HTMLTABLEoutputfilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\HTML\" +"{0:yyyy-MM-dd-hh-mm}" -f (get-date)+"GPOEvents.htm"
$HTMLFullReportFilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\HTML\FullReportGPOEvents.htm"
$CSVoutputpath = 'C:\inetpub\wwwroot\Reports\GPOMonitor\CSV'
$CSVHEADERoutputfilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\CSV\CSVHEADERGPOEvents.CSV"
$CSVTABLEoutputfilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\CSV\" +"{0:yyyy-MM-dd-hh-mm}" -f (get-date)+"GPOEvents.htm"
$CSVFullReportFilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\CSV\FullReportGPOEvents.CSV"
$GPOListingFilename = "C:\inetpub\wwwroot\Reports\GPOMonitor\HTML\GPOHistoricalRoster.CSV"
$TodaysDate = "{0:yyyy-MM-dd hh:mm tt}" -f (get-date)
$GPOHistoryOutputPath = "C:\inetpub\wwwroot\Reports\GPOMonitor\GPOHistory" 
$GPOHistoryListing = "C:\inetpub\wwwroot\Reports\GPOMonitor\GPOHistory\GPOHistory.TXT"
...
$LastRuntime = gci ($HTMLoutputpath + "\") | sort LastWriteTime | select -last 1 | select LastWriteTime

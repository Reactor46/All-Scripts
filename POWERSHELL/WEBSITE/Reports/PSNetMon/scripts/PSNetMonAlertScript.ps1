...
param($zip=89113,[switch]$Celcius,[switch]$Popup)
...
#HTML Export
$Script | ConvertTo-HTML -Head $HTMLHeader -Body $HTMLBody  | Out-File "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\alerts.html"
#}
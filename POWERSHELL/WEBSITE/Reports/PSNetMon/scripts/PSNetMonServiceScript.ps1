...
#Define Server & Services Variable$ServerListA = Get-Content "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\cfg\servicehosts.cfg"$ServicesListA = Get-Content "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\cfg\services.cfg"
...
#Define other variables$CSS = get-content "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\css\theme.css"$Report = "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\gen\servicehosts.htm" $Dated = (Get-Date -format F)$checkrep = Test-Path "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\gen\servicehosts.htm" 
...
foreach ($machineName in $serverlist) 
 { 
  foreach ($service in $serviceslist)
    ...
    #CSV for reports$countresults1=@"$Dated,$machineName,$svcName,$svcState"@$countresults1 | Add-Content "C:\Scripts\Repository\jbattista\Web\Reports\PSNetMon\reports\services.csv"              
                                                   }

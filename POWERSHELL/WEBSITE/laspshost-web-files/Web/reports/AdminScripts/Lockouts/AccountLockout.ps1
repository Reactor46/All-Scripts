...
{
    $error.clear()
    Write-EventLog -EventId $($count + 700) -LogName Application -Message "Count = $count" -Source "AccountLockout.ps1"
}
...
$scriptDir = "C:\Scripts\Repository\jbattista\Web\reports\AdminScripts\Lockouts"
...
{
    # Email Alerts
    $SMTPServer = "intmail.vegas.com" # (CHANGE ME)

    # The address from which to send the lockout alerts.
    $SMTPFrom = "Account_Lockout@vegas.com" # (CHANGE ME)
    ...
    $Monitor['Users'] = "john.battista@vegas.com" # (CHANGE ME)
}
...
If($BuildWebPage)
{
    ...
    $SiteDir = "C:\Scripts\Repository\jbattista\Web\reports\AdminScripts\Lockouts" # (CHANGE ME)
...
$htmlfile = "$SiteDir\AccountLockouts.htm"

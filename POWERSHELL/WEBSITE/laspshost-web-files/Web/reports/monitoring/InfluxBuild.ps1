...
$DownloadDirectory = 'C:\Scripts\Repository\jbattista\Web\monitoring\Influx'

if(!([io.directory]::Exists($DownloadDirectory)))
{New-Item -Path 'C:\Scripts\Repository\jbattista\Web\monitoring\Influx' -ItemType directory -Force -ErrorAction Ignore -Verbose}

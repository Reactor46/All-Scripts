...
#
$counters = ("MSExchange Search Indices(*)\Age of The Last Notification Indexed",
...
#
$copyHealthKeyPath = "SOFTWARE\Microsoft\ExchangeServer\v15\ContentIndex\CatalogHealth\"
...
# Thresolds for detection. 
# $todo$ Should these be taken as input parameters?
#

# Stall threshold is 2 hours
#
$stallThresholdInSeconds = 2 * 60 * 60
...
#
$defaultRestartTimeout = new-timespan -Minutes 30
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU0tTC2WCjEzHHQDWpvXlhVgbe
# sDigghhkMIIEwzCCA6ugAwIBAgITMwAAAJvgdDfLPU2NLgAAAAAAmzANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUFJaHGN5ChaK8w7JePSJzwMCcHlEwXAYKKwYB
# BAGCNwIBDDFOMEygJIAiAEMASQBUAFMAQwBvAG4AcwB0AGEAbgB0AHMALgBwAHMA
# MaEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vZXhjaGFuZ2UgMA0GCSqGSIb3
# DQEBAQUABIIBAAZkUpNYyAGbN+8lt/Ftlf011ziaju4/aTac2Qi+6lr2lRzjFHAr
# 919E/xWfDMhDZT1asbv4QjBGcSnYH2+qZOnp26Pj8i9gJ6YnKOutSC2T8EgAq9WW
# V49/SAMXAM0Y+mopXtAKhR5rUwFt69g+vJP40alkyXzEaTz051OxqZCEBK5xpSjt
# bipOKsjlCXkQJ+LAqrJoqa68pkZA8xjVBd22NaXWkPJO5CbhHpEDw7zDcjTSe2Cq
# QPxL9IVjJ5f0PuxYI7ZN0ZaZ13p3M2YZXvVdjcO6P5cuuImFdSEWO+v0dlX1SEGb
# l644Q1vf2DI7leLR7P0/eOLfVZtxqBpQraShggIoMIICJAYJKoZIhvcNAQkGMYIC
# FTCCAhECAQEwgY4wdzELMAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24x
# EDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3JhdGlv
# bjEhMB8GA1UEAxMYTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENBAhMzAAAAm+B0N8s9
# TY0uAAAAAACbMAkGBSsOAwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcB
# MBwGCSqGSIb3DQEJBTEPFw0xNjA5MDMxODQ0NTJaMCMGCSqGSIb3DQEJBDEWBBRC
# +jg11PcgJvVg6z3Er/gdOUKl/zANBgkqhkiG9w0BAQUFAASCAQBAGnsWITADaY17
# MWTI2pFMWTBlSH1JO9t2MJrE6DflspkyX5c2LwtdjfPco5Juhf36ENUVLP4LphZL
# XK5hf0W1Cehgq13Qi8AcE4J9ac8FWeQnmsLpZu1ns3WUgXx4TKIArEosN/HA9TjG
# 6LPzBDvpRvB04ppJ8lvAOToIqwOh1q3JqzwMFL+GZ8MSg8C3ooUzh633wKH3ZKkl
# vzJvj7AYGno5iQSypGanKTPxeMsTEYpE1iM5GZrcZII5P2+vD9gGT/4wY7eCnUzw
# /UmUkzyPi6Iw1GmFmjSCu7xYv/P+v/KLRMgFx+72oLuUR6ukinwP7dC8WaLXz8q+
# g7+p0spS

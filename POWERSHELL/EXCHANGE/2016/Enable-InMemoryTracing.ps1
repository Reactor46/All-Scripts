$binpath = (get-itemproperty HKLM:SOFTWARE\Microsoft\ExchangeServer\v15\Setup).MsiInstallPath + "Bin\"
...
gc ($fullpath + ".bak") | %{$_.Replace("InMemoryTracing:No","InMemoryTracing:Yes")} | out-file -FilePath $fullpath

# SIG # Begin signature block
# MIIdtAYJKoZIhvcNAQcCoIIdpTCCHaECAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUZb4+ZpsrD2wuB8cXGYQKLb3H
# esOgghhkMIIEwzCCA6ugAwIBAgITMwAAAK7sP622i7kt0gAAAAAArjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQURmFUlFl+tgEUXLuvKwo1eSokD3owbgYKKwYB
# BAGCNwIBDDFgMF6gNoA0AEUAbgBhAGIAbABlAC0ASQBuAE0AZQBtAG8AcgB5AFQA
# cgBhAGMAaQBuAGcALgBwAHMAMaEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20v
# ZXhjaGFuZ2UgMA0GCSqGSIb3DQEBAQUABIIBAHWH3kSer5wBdNmdA95v7BUhoQqA
# i30hZh1X+RF94NrA+2UwWQRn7RloIfOLrtSC5qEWxsjSLb1u0fJY0vj9jJ+rvzsn
# cudKg5Dd6/NtCT64BxK/0y4nXLKNtCwcj72Q0Z7mMZXoRAb7j5cnYm2ovw8ySNiw
# KkN+R/I0nLQiAh1waEtoAPFDRt8XJBLimJpl8Qf8A3JnwCOHQW3waEFgcxeE+GbF
# AXwXJ7WSYuT/TK1KdyXIHHq2y0918KKN6PKx3bfIPidDGzIcLMpe1WEJ4+8Z3Kgw
# An23g8MNSwq28J8MmWlLm1MJG1udbSsvJdO2xAQu8Ov4rx+gnIz4zccOHcChggIo
...
# 9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xNjA5MDMxODQzMTJa
# MCMGCSqGSIb3DQEJBDEWBBQ0pXXVLU5o0Wd4wqAOX4QntnzSXDANBgkqhkiG9w0B
# AQUFAASCAQC6OXgUosJ6x5a4I2K7IZpAPsDEnTiGTtBv8xFLMjTYf66uwnyotBEp
# 1xIp9mdPBuZQTJuF/VbULF58Und52PDvOYtes0sAt4wHvIvraCyHbDMEnNgUu+8S
# dN9KLmVeCRg8kDu5yW2KGdLaPZx84qXwEQohD+udrv0ivpE7UqiOSebjZfFL+U1e
# BxyJketSeIO42IDO4lu8shN2wssUUTr3uBRWPPxx0Z6hRNRKf7qM6MBp1GfBMZeq
# YTvBvY2V/b9qdgkaAbZofimP9nKvsg/TnJDKF3CzVGJLOpVm0zxKX+UNQRj813W+
# /9VqDiKSHTq19gq+sJDw68JeLMizlW9N

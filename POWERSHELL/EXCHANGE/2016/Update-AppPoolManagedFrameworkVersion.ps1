...
# Synopsis: Update AppPool Managed Framework version
#           
...
process
{
  Write-ExchangeSetupLog -Info "Update-AppPoolManagedFrameworkVersion beginning...";
  Write-ExchangeSetupLog -Info $AppPoolName;
  Write-ExchangeSetupLog -Info $Version;
  ...
  if ($appPool -eq $null)
  {
	Write-ExchangeSetupLog -Info "Unable to find AppPool, nothing changed";
  }
  else
  {
	$appPool.ManagedRuntimeVersion = $Version;
    $ServerMgr.CommitChanges();
	Write-ExchangeSetupLog -Info "Update succeeded.";
  }
}
# SIG # Begin signature block
# MIId0wYJKoZIhvcNAQcCoIIdxDCCHcACAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUz6+xvE410lpa53/Fo4Wr0EQR
# MLGgghhkMIIEwzCCA6ugAwIBAgITMwAAAJvgdDfLPU2NLgAAAAAAmzANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU0xnCKNuql+Q9E7zhuF5dXNlrDG0wgYwGCisG
# AQQBgjcCAQwxfjB8oFSAUgBVAHAAZABhAHQAZQAtAEEAcABwAFAAbwBvAGwATQBh
# AG4AYQBnAGUAZABGAHIAYQBtAGUAdwBvAHIAawBWAGUAcgBzAGkAbwBuAC4AcABz
# ADGhJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29tL2V4Y2hhbmdlIDANBgkqhkiG
# 9w0BAQEFAASCAQAdXla24sBz3kFIz/Uc1WPOz2iDg7JOVDm3aYgUFSCCmhkr/hG7
# 3o0tSIBzO9JajhEf2mLfDl1lNVmE4P8Kv6RBPBY28RwSlzWTJEbhsr/bu/I3J7jc
# Ae84OWDCMtjR8z2yYLcZWi0E77hpvZs4lXeeA5RVSWXF8+iA2FI8KaUoNogVFZGw
# lxcyS+sZqUAg41V61HP11ShoLw0Iw0jIkQw4FT2d7dB3P8ZwGbFv76YXxEn56DnG
# viO4S2mebeorqDkfeG1mMc4jEY/S71NX+CRF5qlnNDJoQAyys3pXkOb7lODPcRqP
# 65p4fGGR4VmFPUMaIoXDLPLrCWBjiu0SYaK8oYICKDCCAiQGCSqGSIb3DQEJBjGC
# AhUwggIRAgEBMIGOMHcxCzAJBgNVBAYTAlVTMRMwEQYDVQQIEwpXYXNoaW5ndG9u
# MRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3NvZnQgQ29ycG9yYXRp
# b24xITAfBgNVBAMTGE1pY3Jvc29mdCBUaW1lLVN0YW1wIFBDQQITMwAAAJvgdDfL
# PU2NLgAAAAAAmzAJBgUrDgMCGgUAoF0wGAYJKoZIhvcNAQkDMQsGCSqGSIb3DQEH
# ATAcBgkqhkiG9w0BCQUxDxcNMTYwOTAzMTg0NDQ2WjAjBgkqhkiG9w0BCQQxFgQU
# C+28vYRC46IG0EkXh2I5DcpmIlEwDQYJKoZIhvcNAQEFBQAEggEAXvm/gBAP1OeW
# d6UCHIZLYgl9LDCQJuugLXVpXeiN9oQaAL9JPoDJXMSIUBq7Ze1Br0vndpn9DRB5
# uLpzsYkpGhDZoMr4WFLXaveJQP9alzEeVmhI1iE8zCaE1WGVGuLYDGqy1eHOrMa+
# tWB+FUKWIbpxkAifKEZgKMhWKgXrUiaHxowaNzoTHDyWPsWnfLq+j2PPFnM9QtKv
# BXVYBYdFmQ5+zuGx9wY98mYb86IJNugu17BCOtOSkOkInBjYfI8JZT1m01nksqer
# jXVt7JuUAoyCxSIphyiQYSP4XQOLOAfwjOMF6wvEdXgDuW+iD1Km0f3w9EnfFr9Y
# yGwcOVvqWA==

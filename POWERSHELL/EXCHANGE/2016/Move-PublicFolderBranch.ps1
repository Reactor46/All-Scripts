...
if ($script:publicFolder -eq $null)
{
    exit;
}
...
{
    $script:FoldersToMove += $script:publicFoldersToProcess[$index].Identity;
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUvPBjV1jKKrswqblpPRueEAFW
# 2eGgghhkMIIEwzCCA6ugAwIBAgITMwAAAJ1CaO4xHNdWvQAAAAAAnTANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUVxwF8i9v1Czasd6PFdg5l4e7amUwcAYKKwYB
# BAGCNwIBDDFiMGCgOIA2AE0AbwB2AGUALQBQAHUAYgBsAGkAYwBGAG8AbABkAGUA
# cgBCAHIAYQBuAGMAaAAuAHAAcwAxoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNv
# bS9leGNoYW5nZSAwDQYJKoZIhvcNAQEBBQAEggEAVaVIiG1Lb+aTaWTqKGtI20fh
# /nrdpQv3cLuWULacHCBAyWVhgYdZqxG1D2vBj7yzs5q0dInpMmLgsqle8k4xgaxz
# MhFgMoPgcWihRMqzK46EpTjOb5CObB80K3gN9VcRQwz0wydHCSOsD7KswL43/usj
# DVQKepLMqDxgNdPtRkKvBtTxQ3l/M8ebylFZQ9G2whh1OZrcQeLq0VjJDNirkJXD
# a6Gmd0hkbIdPi4pzc/c8Gzt57+Q+7g4jImKreA1PA4zyqNyYkDx10cllA1xaLoIx
# XkXenNQZZq8I3IIxrfQrsMkdcWNt1dYjMAOmVdsFzLV9EWeub6bCK/S72zlBfaGC
...
# SIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTE2MDkwMzE4NDUx
# OFowIwYJKoZIhvcNAQkEMRYEFNMs9HJ3PFTYqCegJcyxZa8/ul11MA0GCSqGSIb3
# DQEBBQUABIIBAJMx0B7ZhHsJ6ZLcRPy8WYXhMBeLzOYagGageMS45DtbstPsAndz
# bcOxGhXWZBhj1By2YAwP7vKgUK4ZMhIFlKf+p/uSPYycDibtIwrUondDiTwABCXU
# mOP4SFAjzLrfXwpsc7x8TKcKv118NeL6JEwAjPYOIybWBB1YD70BtQa+f2GKp4Vp
# TmAxiHgkDkHbNQOFgnDBwRwKGdk3rWJriQFMrI3vwuFo6O8GG+U1tPkwnAn546yR
# h4TimAs/uJW6r5ek8oyloxYBNz896Bu0upNZU+9+645jflo8Ta3M53dP828rTrFQ
# jCdfwQgNAufUX6TAhmFeGYb/TvGakFdIPfI=

...
$DlpPolicyAgent =
    @("DLP Policy Agent",
      "Microsoft.Exchange.MessagingPolicies.DlpPolicyAgent.DlpPolicyAgentFactory",
      "Rule\Microsoft.Exchange.MessagingPolicies.DlpPolicyAgent.dll",
      $true)
$MalwareAgent =
    @("Malware Agent",
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUftcZbZhQajwxuqVzW/YdcWHh
# wHCgghhkMIIEwzCCA6ugAwIBAgITMwAAAJqamxbCg9rVwgAAAAAAmjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU7ABdgJ9/ucG5lW43GejuvpswV60wgYAGCisG
# AQQBgjcCAQwxcjBwoEiARgBSAGUAaQBuAHMAdABhAGwAbABEAGUAZgBhAHUAbAB0
# AFQAcgBhAG4AcwBwAG8AcgB0AEEAZwBlAG4AdABzAC4AcABzADGhJIAiaHR0cDov
# L3d3dy5taWNyb3NvZnQuY29tL2V4Y2hhbmdlIDANBgkqhkiG9w0BAQEFAASCAQAV
# 9JR2AeoCaHni5myT4MnIat4LqSei6PcOsGmw6M6MKlxFIrOP5JjryavWJXLxfNSA
# X7llNmxO7LoGSsthXwerKmA1op1/Zvattv0F9GUGEnyw9qJKhrshEWC+rb8l3Ody
# qc2H/vcgwvSoaXfUxmhMq12RUupnZWTe9YAxv8G43W9zCunVHDhnqoV96kuvUcUF
# yWCEv1PU3KYtP+4BTpf5MDHp8Z5ynhoe1+u+Bzo7zkeh4mz41+WcviB6+D6BoXrN
# v52DPPR/i6zVDn0ebPs2x8beFo4SBznpPkP1COclQij+0wulQmMFYNTpO/5gJQkt
# tN5OJNo9XYRjb099fDF3oYICKDCCAiQGCSqGSIb3DQEJBjGCAhUwggIRAgEBMIGO
...
# CQUxDxcNMTYwOTAzMTg0NDA2WjAjBgkqhkiG9w0BCQQxFgQUtlt6lLoC77dkW6AC
# Gk4IGipK6kowDQYJKoZIhvcNAQEFBQAEggEAYjldgonzzlWZwLMJYp6Xs1uCLgzF
# ppfnbvm0Bewhv4e1IXaqiOZ2GSkwcNL7+1212WAUEUaBjxw0caIYf9OlefNdSiRT
# 7z7upCpPbip8BhMxfLxlBu0Tfh9jHC44/4qvLP8ZiYehXPkIx5Ichw4ncN879mrH
# 5aa2Ga8sJdQfz4hGeDIubttnQvi2fFMIjU3rlZwDUmH81GXetWJAMTaHPLnKhIoJ
# J5aDFjqWzSh4P/cuNHT0TkBRgOSnjWCl9lTTZQQm292GdUNbnVwp5PLaWgRv2P8s
# SKdFkHLnEHEy8Tp+1Vz7L/e5iUASC5Hf8jd0vc49S0H/Ld14Fc7DrMiH+A==

# Add FIPS PowerShell snapin
Add-PSSnapin Microsoft.Forefront.Filtering.Management.PowerShell

$dbPath = (get-itemproperty HKLM:\SOFTWARE\Microsoft\ExchangeServer\V15\FIP-FS).DatabasePath

$outputFilePath = $dbPath + "ValidEnginesData.xml"

Get-ValidEngines | Export-Clixml -Path $outputFilePath -Depth 50


# SIG # Begin signature block
# MIIdpgYJKoZIhvcNAQcCoIIdlzCCHZMCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUNs/fFnMfdlA8MuGUPbcNxCpX
# hEagghhkMIIEwzCCA6ugAwIBAgITMwAAAJqamxbCg9rVwgAAAAAAmjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUD0voxH7cxsdOtdlSRmu19F49cygwYAYKKwYB
# BAGCNwIBDDFSMFCgKIAmAEcAZQB0AFYAYQBsAGkAZABFAG4AZwBpAG4AZQBzAC4A
# cABzADGhJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29tL2V4Y2hhbmdlIDANBgkq
# hkiG9w0BAQEFAASCAQBVvLBai8p1foItg3Hk7DZt6z/LhUqJT00kJbaUIIoaauGh
# iQcE/hDil6QW718hn7NCrz2v62Caiy/I6gB4itDX75KiEIrl7asnukwSUxn7uuUU
# oCgsrmhOZlk5o7FPsRfqyzJ5iJPTtX/iGW8k1ycPEAv6QqSGp5ju4AueCTaiXrj5
# tX+H33w30DYyXueVwbmBAxJ9U9keH55VWqzrNxAOwKgFWIQSNOIlva6a+VkbZP1o
# jv3QRDjlgi+Iy6pDC7+rR1vXlOQ+NmRUyMwAn6jbXlkBJqFJOXgE75ZUUr0BbjsH
# N0XdjkNO8KhrZVtiYQN+a93F3/NIl0Yiq0sY+MCJoYICKDCCAiQGCSqGSIb3DQEJ
...
# DQEHATAcBgkqhkiG9w0BCQUxDxcNMTYwOTAzMTg0NDUyWjAjBgkqhkiG9w0BCQQx
# FgQUSNNo206yL+Z5/S7toKXjZ/CdsbMwDQYJKoZIhvcNAQEFBQAEggEAEdZBCkF5
# 5gqLQu8E/DolTQfFL34cz08nA1qgdMO4MqNVJecPq4hgvkBfq1jJAtJqPBpjsp4A
# H3aA8GqVvjaHp3+YncVbWGoAsjeYx5kAtiMr1mQ2VleTqDqgm4zpEjtfPugrQrK6
# zo2415LqWTP2fHbhR0R4OW9krFGpQTC3MX657ULgE6K+0A2+BZONoUh0iclPIJ3w
# UnBOu++N5oU5pRT+AUMSLxVXrnm8YyMgew8/65RxlMoq8Qx86OD/We21+5s18P3w
# M1o4+MqE4s70Q1ndDPkEXzvoEEEf/dNbOq3AKRHyQ4LyTYJCQ7GPCKWHPoJQUVoj
# alK98/CwvqBywg==

...
$service1 = New-Object Microsoft.Exchange.WebServices.Data.ExchangeService([Microsoft.Exchange.WebServices.Data.ExchangeVersion]::Exchange2007_SP1)

$windowsIdentity = [System.Security.Principal.WindowsIdentity]::GetCurrent()
$sidbind = "LDAP://<SID=" + $windowsIdentity.user.Value.ToString() + ">"
$aceuser = [ADSI]$sidbind

$service1.AutodiscoverUrl($aceuser.mail.ToString())

$folderid = new-object  Microsoft.Exchange.WebServices.Data.FolderId([Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::Contacts,$MailboxName)
$ContactFolder = [Microsoft.Exchange.WebServices.Data.Folder]::Bind($service1,$folderid)

$ContactProps = @{ }

SetProp "Normal" "GivenName" "Er"
SetProp "Normal" "Surname" "You"
$fileasName = "Er" + "," + "You"
...
SetProp "Normal" "BirthDay" (Get-Date "5/1/1974 7:00 AM") 
SetProp "Email" "EmailAddress1.Address" "glenscales@yahoo.com"

CreateContact $service1 $ContactProps $ContactFolder

$Global:newContact.SetExtendedProperty($email1DisplayNameProp,"dD")	
$Global:newContact.Update([Microsoft.Exchange.WebServices.Data.ConflictResolutionMode]::AlwaysOverwrite)

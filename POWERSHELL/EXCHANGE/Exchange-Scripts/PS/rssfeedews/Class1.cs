...
namespace EWSUtil
{
 ...
 //           ewsContact.Body.Value = cnContact.Notes;
    ...
    {
        public WriteFeed(ExchangeServiceBinding esb,String emMailboxEmailAddress, String fnFileName, String fnFeedTitle, String snServerName, List<ItemType> miMailboxItems)
        {
            try
            {
                String StartTime = "";
                ...
                foreach (ItemType itItemType in miMailboxItems)
                {
                    ...
                    xrXmlWritter.WriteElementString("title", itItemType.Subject.ToString());
                    ...
                    if (itItemType is CalendarItemType)
                    {
                        ...
                        xrXmlWritter.WriteRaw(SecurityElement.Escape("Start : " + StartTime + "<br>" + "End : " + EndTime + "<br>" + "Location : " + Location + "<br><br>"));
                    }
                    ...
                    else
                    {
                        ...
                        if (rmResponseMessage.Items.Items[0].Body != null)
                        {
                            if (rmResponseMessage.Items.Items[0].Body.Value != null)
                            {
                                ...
                                xrXmlWritter.WriteRaw(SecurityElement.Escape(bsBodyString.Replace("<meta http-equiv=\"Content-Type\" content=\"text/html; charset=utf-8\">\n<meta name=\"Generator\" content=\"Microsoft Exchange Server\">\n", "")));
                            }
                        }
                    }

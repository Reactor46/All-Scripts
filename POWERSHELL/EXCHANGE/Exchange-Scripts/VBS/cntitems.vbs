...
treport = treport & "<td align=""center"" bgcolor=""#000080"" colspan=""2""><b><font color=""#FFFFFF"">Less Than " & numbdays & " Days</font></b></td>" & vbcrlf
treport = treport & "<td align=""center"" bgcolor=""#000080"" colspan=""2""><b><font color=""#FFFFFF"">Greator Than " & numbdays & " Days</font></b></td>" & vbcrlf
treport = treport & "</tr>" & vbcrlf
treport = treport & "  <tr>" & vbcrlf
...
set wfile = fso.opentextfile("c:\temp\Server-" & Servername & "-CntItems.htm",2,true) 
wfile.write treport
wfile.close
set wfile = nothing
set fso = nothing
...
strQuery = strQuery & """urn:schemas:httpmail:fromemail"", ""http://schemas.microsoft.com/mapi/proptag/x0e080003"" As Msize"
...
ElseIf req.status = 207 Then
   ...
   For i = 0 To (oNodeList.length -1)
		...
		If CDate(DateSerial(mid(oNode3.text,1,4), mid(oNode3.text,6,2),mid(oNode3.text,9,2))) > dateadd("d",-numbdays,now()) Then

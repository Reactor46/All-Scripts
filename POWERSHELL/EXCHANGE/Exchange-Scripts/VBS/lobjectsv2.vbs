...
Else
	...
	For uic = LBound(uarray,3) To UBound(uarray,4)
		...
		report = report & "<td align=""center"">" & garray(0,0,0,uic) & "&nbsp;</td>" & vbcrlf
		report = report & "</tr>" & vbcrlf
	Next
...
If objecttype = "group" then
	objQuery = "<LDAP://" & ou  & ">;(&(mailnickname=*)(|(objectCategory=group)));description,name,cn,distinguishedName;subtree"
Else

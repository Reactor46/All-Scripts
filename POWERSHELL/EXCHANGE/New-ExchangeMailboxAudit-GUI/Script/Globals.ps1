...
$varEmailRecipient="jbattista@optummso.com"
$varEmailSender="MailboxAudit@uson.local"
$varSMTPServer="192.168.1.8"
...
$ConfigFile = "C:\LazyWinAdmin\RESULTS\Exchange\Config.xml"

...
wend
Wscript.echo 
Wscript.echo "Users with Max-Recipient Limits"
wscript.echo 
srquery = "<LDAP://" & strDefNamingContext & ">;(&(&(objectCategory=Person)(objectclass=user)(msExchRecipLimit=*)));name,displayname,distinguishedName,msExchRecipLimit;subtree"
Com.ActiveConnection = Conn
Com.CommandText = srquery
Set Rs = Com.Execute
While Not Rs.EOF
	wscript.echo "User:" & rs.fields("displayname")
	wscript.echo "Recipient Limit:" & rs.fields("msExchRecipLimit")
	wscript.echo
	rs.movenext
wend

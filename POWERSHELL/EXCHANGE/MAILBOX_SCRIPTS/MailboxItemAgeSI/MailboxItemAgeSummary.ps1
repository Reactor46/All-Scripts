...
$rptCollection = @()
$fnFinalreporttlt = "" | Select Name,TotalNumber,TotalSize
$fnFinalreporttlt.Name = $MailboxName
$rptCollection += $fnFinalreporttlt
$fnFinalreport = "" | Select Name,TotalNumber,TotalSize
...
$rptCollection | ConvertTo-HTML -head $tableStyle –body $body | Out-File c:\temp\MailboxAgeReportSummary.htm
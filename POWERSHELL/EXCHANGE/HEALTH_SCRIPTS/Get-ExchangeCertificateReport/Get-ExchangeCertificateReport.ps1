...
Send-MailMessage -Attachments $reportfile -To 'jbattista@optummso.com' -From 'USONVSVREX01@uson.local' -Subject "Exchange Certificate Report" -BodyAsHtml $htmlreport -SmtpServer 'smtp.uson.local'

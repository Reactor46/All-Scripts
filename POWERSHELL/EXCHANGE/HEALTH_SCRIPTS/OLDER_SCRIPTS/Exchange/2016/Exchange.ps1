...
Import-LocalizedData -BindingVariable Exchange_LocalizedStrings -FileName Exchange.strings.psd1
...
## Turn on RBAC on non-Edge Exchange installs. We do it if we can find the 
## common Exchange regkey but cannot read the Edge-specific one
$global:useRbac=(test-path HKLM:\SOFTWARE\Microsoft\ExchangeServer\v15) -and `
!(test-path HKLM:\SOFTWARE\Microsoft\ExchangeServer\v15\EdgeTransportRole\AdamSettings\MSExchange)
...
{
	write-host $Exchange_LocalizedStrings.res_welcome_message

	write-host $Exchange_LocalizedStrings.res_full_list -no 
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0003

	write-host $Exchange_LocalizedStrings.res_only_exchange_cmdlets -no
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0005

##	write-host " Only Monad cmdlets:            " -no
##	write-host -fore Yellow "get-pscommand"

	write-host $Exchange_LocalizedStrings.res_cmdlets_specific_role -no
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0007

	write-host $Exchange_LocalizedStrings.res_general_help -no
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0009

	write-host $Exchange_LocalizedStrings.res_help_for_cmdlet -no
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0011

	write-host $Exchange_LocalizedStrings.res_team_blog -no
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0015

	write-host $Exchange_LocalizedStrings.res_show_full_output -no
	write-host -fore Yellow $Exchange_LocalizedStrings.res_0017
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjcKg1yeYCC1kT99Hi1Pwltsp
# qkygghhkMIIEwzCCA6ugAwIBAgITMwAAAJzu/hRVqV01UAAAAAAAnDANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQU1vn8INmgBWNFifqVHRSETYofcrIwUgYKKwYB
# BAGCNwIBDDFEMEKgGoAYAEUAeABjAGgAYQBuAGcAZQAuAHAAcwAxoSSAImh0dHA6
# Ly93d3cubWljcm9zb2Z0LmNvbS9leGNoYW5nZSAwDQYJKoZIhvcNAQEBBQAEggEA
# OTJ2MuJSxb0kkUJTuT6s/72VFXO8KnQuZtksnHTX5cGD7+2N92Mlw3Vpg5ev3VCD
# hcMzRazszRHnH1/ufRPkLm0XZVE7u8/6JUujLIxIhUcRIDsA0j4VQaK7a9KiNE/0
# rzXWmqawwQ+5g8UU5itvO+KSBW57pCRPrpyPNnPJXCYIazxKzMwCE6I7jYQUuxux
# RsL/L9qSAeFb9Mr/idIiW8v/xjThA1hFS7L/++wT6/hN9IHMe/5bhx7H3SQ77ZMh
# sZoEjdLBBgtNaZQlKxuwOedUi3k3uqcxIWClSuWHJiNHnbE/v1gGToN87cQ3NdsH
# +f2pl7LAZzVCYIJGLTHjOKGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCB
...
# ExhNaWNyb3NvZnQgVGltZS1TdGFtcCBQQ0ECEzMAAACc7v4UValdNVAAAAAAAJww
# CQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcN
# AQkFMQ8XDTE2MDkwMzE4NDQzNlowIwYJKoZIhvcNAQkEMRYEFPz704sVkgn5fHvW
# wQnKl5+1uq3ZMA0GCSqGSIb3DQEBBQUABIIBAJwvX/4k2GwExGKDGztphlyUW6Py
# NC8CWy5bPDMNrF97e48aMc2TKS3FCXG26h2gmnIR28C4/J9hounq1vJB1zLGC518
# R0+6AiCTy8rUDtZB023S3jkaRbemIuOsF8R7Pm+JpXzQkhJUxAMoceuatBlD83Ye
# n63nh9laq9Kgpp7C9hLDccr7Df4VBjmbk2IeJ1Qxusgk6owBNfmqNuzryGu4GI00
# 8msW3wSz/VREZEXc2b4Z5yteYtE1Bux7bx2MbXBc6U9AritmOZ1yA2IUgBZHrC6X
# 6C/XB/PD7fRMuSUaBPyxwvcpJpcHwPDh8ZRRHqsuPc3FuFYHnapTPzNY6vQ=

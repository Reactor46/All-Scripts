...
# Get Last update time of the MM flag for $dcName on the given $dcFQDN
function Get-ProvisioningFlagLastUpdateTime (
[string] $dcName,
[string] $dcFQDN)
{    
    $lastUpdated = $null;
    ...
    try
    {
        $property = "msexchprovisioningflags";
    
        $path = ""
        $domain = $dcFQDN.Substring($dcFQDN.IndexOf('.') + 1)
        
        foreach ($name in $domain.Split('.'))
        {
            $path += ('DC={0},' -f $name);
        }

        $path = $path.Remove($path.Length - 1);
        $objectDN = "CN="+$dcName+",OU=Domain Controllers,"+$path;
      
        # Sets Context to Domain for System.DirectoryServices.ActiveDirectory.DomainController
        $context = New-Object System.DirectoryServices.ActiveDirectory.DirectoryContext -ArgumentList([System.DirectoryServices.ActiveDirectory.DirectoryContextType]::DirectoryServer, $dcFQDN);
        ...
        $newobj = $meta.$property;
        
        $lastUpdated = [System.DateTime]($newobj."LastOriginatingChangeTime").ToUniversalTime();
    }
    catch
    {
        ## return default $null if there was an exception
    }
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUQffs0lDkkfyuIVejcUitIwup
# VL+gghhkMIIEwzCCA6ugAwIBAgITMwAAAJvgdDfLPU2NLgAAAAAAmzANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUnqvZDH3LZBndvHB3H9pJgvWnwVswfAYKKwYB
# BAGCNwIBDDFuMGygRIBCAEQAaQBhAGcAbgBvAHMAdABpAGMAUwBjAHIAaQBwAHQA
# QwBvAG0AbQBvAG4ATABpAGIAcgBhAHIAeQAuAHAAcwAxoSSAImh0dHA6Ly93d3cu
# bWljcm9zb2Z0LmNvbS9leGNoYW5nZSAwDQYJKoZIhvcNAQEBBQAEggEABaOiO++t
# XbMVtfWN6wL0xa4hyNxjIlnBRjPcOAPktdIYDYcUM2UsG+ZyCodbozS3bQT2obQo
# AO7TmCgacNq2tYFAUVgBYi7QvWWeTzoDE16FTz5I2uLhcDAtAXl9/Y1jcWIuX9Lm
# RKEznBuKRqff4+T30i9VjVIaF5Ip1Zd0B3Qcf0i2eOVIhRBr0acUKY0hGvTH8Gwg
# 7MM81DBK1gCkZYnm4IKMKqZ/8xd9sBMA0w37u3pCbVK1yEChP/COAVbMcH5tSF1H
# CGHAo3x2v3k7U7GCLBFyRunr7qXacwH8vTskbHsRgGBgGug/O+J1UBiHzzFrNY8H
# ltMUNWIt6oOKSqGCAigwggIkBgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQsw
# CQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9u
# ZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9uMSEwHwYDVQQDExhNaWNy
# b3NvZnQgVGltZS1TdGFtcCBQQ0ECEzMAAACb4HQ3yz1NjS4AAAAAAJswCQYFKw4D
# AhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8X
# DTE2MDkwMzE4NDQ1NVowIwYJKoZIhvcNAQkEMRYEFEP1C8dR0Xa5Bb4UCX3laeWn
# QViwMA0GCSqGSIb3DQEBBQUABIIBAHhdhh7e7nvu7Yh2l9BUwku2Cjr2RdH7FlF/
# 7IUkx1mWWk/nFoX8rnCtul7K82nC7B0Ux2SKWOGayHV0E5y2UySzM4A3MuqDyI8T
# 15VQZsr1OD0IoZDi2wJ2hgaiDSYSZieiG6bVqT22rr/GG2VuF3VBfKDota8iNSSI
# G0wUQlKDUhAY+7Ns3BcqUCmE2Y3gmOvOJjFCbpqYy14cA8LeZXXwaPck2n+o11zy
# fjAlWJgrefSlb3lwu0tRZy/2Oz0qF1fYhW71ocvwfxHT3cSWbPviBCefIkdoTk4o
# CunXUyo5WMhtM8U6f3y3FU/hJLVhfXz5IAUUu/DjXc2l5gSVfKc=

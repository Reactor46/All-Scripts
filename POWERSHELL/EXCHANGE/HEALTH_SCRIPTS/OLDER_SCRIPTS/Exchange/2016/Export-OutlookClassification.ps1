...
#To fix security bug OM #2246067
$Arguments = @{}
if ($Organization)
{
    $Arguments.Add("Organization",$Organization)
}
if ($Locale)
{
    $Arguments.Add("IncludeLocale", $True)
}

if ($Locale)
{
    $classifications = Get-MessageClassification @Arguments | where {$_.Locale -eq $Locale}
}
else
{
    $classifications = Get-MessageClassification @Arguments
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUbDH+L7N+vBW7xBLzyGx2f7CE
# daqgghhkMIIEwzCCA6ugAwIBAgITMwAAAJqamxbCg9rVwgAAAAAAmjANBgkqhkiG
...
# NwIBFTAjBgkqhkiG9w0BCQQxFgQUpXTv9DyKhieIOk6Bu1zcReBPQPowegYKKwYB
# BAGCNwIBDDFsMGqgQoBAAEUAeABwAG8AcgB0AC0ATwB1AHQAbABvAG8AawBDAGwA
# YQBzAHMAaQBmAGkAYwBhAHQAaQBvAG4ALgBwAHMAMaEkgCJodHRwOi8vd3d3Lm1p
# Y3Jvc29mdC5jb20vZXhjaGFuZ2UgMA0GCSqGSIb3DQEBAQUABIIBAFkbUx7KBylV
# vaZ8JtEQBVbXVhHe0KiCvzIvioSx6C8WqCXwXCldQxaE/jaozUnvGJriDX0SZK0v
# o+pTkSvpBYgWbC52+1LESeYxYR1Wo8QZ0OPq0NDqKqZgwfefRwADp12jP8O82jNp
# DpfkFvYHTfNm8piOW1aCImW3+/lcnQ73c7LhLr3eeMOTogKnAadRJgv9bua4fZfe
# E7TIKwqxgqw1RPWOBVVipTVRowQ1La223MNM98QiXGt3eT/AQqXd5iF+X3Yg3sTj
# 1UpLXq+CCWuwlUNCJvrJpMz/y/3BLPavou6sCR65GXF7SKHEkDMtlxK06i54oK6x
# IXAt5pqpMXuhggIoMIICJAYJKoZIhvcNAQkGMYICFTCCAhECAQEwgY4wdzELMAkG
# A1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQx
...
# NjA5MDMxODQ0MzhaMCMGCSqGSIb3DQEJBDEWBBSX9cGg8hSDxpix3ZX3oceX4CnF
# CjANBgkqhkiG9w0BAQUFAASCAQBMBQB7QQajsJLIE0WdgRIWSgvEcZ43pGnFm56w
# kPVH8kZidwgv1Jq2sdQ2QkhJAjl+Gze2mhFe+YyeXpEQ3jEpDexXi6OGomOuJm5/
# RanEcfW92Juc7wJxNEqc+TVgRh5eWds6GA86sAYNsFV40t3YW4D9/8Esx9X3VS70
# N/3SnLr9UIKPCtYb6amf9vQGaAhitZ8yIr4iSJDj1ueptV9JGt4r0jFBpyFprmlN
# wVPk7/kwG52AvmUBkDM5uoYPyXoRIkNX/nfyRoYZ+p5fnYHT0iMr3zzJG3UQEpki
# +DWiIlfiboFdaUORvDiBUCHBFz0PuhEXEvS+Ve/uijSSoU0L

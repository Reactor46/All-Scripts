...
function OpenMailbox(){
	...
	$Treeinfo.Clear()
	$tvTreView1.Nodes.Clear()
	
	$TNRoot.Name = "Mailbox"
	$TNRoot.Text = "Mailbox - " + $emEmailAddressTextBox.Text.ToString()
	[void]$tvTreView.Nodes.Add($TNRoot) 
	if ($rbinc4.Checked -eq $true){
		$rfRootFolderID = new-object Microsoft.Exchange.WebServices.Data.FolderId([Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::Root,$emEmailAddressTextBox.Text.ToString())
	}else{
		if($rbinc6.Checked -eq $true){
			$rfRootFolderID = new-object Microsoft.Exchange.WebServices.Data.FolderId([Microsoft.Exchange.WebServices.Data.WellKnownFolderName]::ArchiveMsgFolderRoot,$emEmailAddressTextBox.Text.ToString())
	...
	if($service.ServerInfo.VersionString -eq "Exchange2010_SP1"){
		$service = New-Object Microsoft.Exchange.WebServices.Data.ExchangeService([Microsoft.Exchange.WebServices.Data.ExchangeVersion]::Exchange2010_SP1)
	}
	if($service.ServerInfo.VersionString -eq "Exchange2010"){
...
function GetFolderItems(){
	...
	if($rbinc1.Checked -eq $true){
	    $service1 = New-Object Microsoft.Exchange.WebServices.Data.ExchangeService([Microsoft.Exchange.WebServices.Data.ExchangeVersion]::Exchange2010)
		$service1.Url = $service.Url
		$service1.Credentials = $service.Credentials
		$service1.UseDefaultCredentials = $service.UseDefaultCredentials
		if ($seImpersonationCheck.Checked -eq $true){
		$service1.ImpersonatedUserId = $service1.ImpersonatedUserId }
		$service = $service1
		$view.Traversal = [Microsoft.Exchange.WebServices.Data.ItemTraversal]::Associated
	}
	if($rbinc2.Checked -eq $true){
...
$objForm.Text = "CopyForm"
$objForm.Size = New-Object System.Drawing.Size(400,400) 
$objForm.StartPosition = "CenterScreen"
$tvTreView1 = new-object System.Windows.Forms.TreeView
$tvTreView1.Location = new-object System.Drawing.Size(10,10)  
$tvTreView1.size = new-object System.Drawing.Size(216,400) 
$tvTreView1.Anchor = "Top,left,Bottom"
[void]$tvTreView1.Nodes.Add($TNRoot.Clone()) 
$objForm.controls.add($tvTreView1)
$exButton9 = new-object System.Windows.Forms.Button
$exButton9.Location = new-object System.Drawing.Size(250,10)
$exButton9.Size = new-object System.Drawing.Size(150,20)
$exButton9.Text = "Copy selected Items"
$exButton9.Enabled = $true
$exButton9.Add_Click({
		$cfCurrentFolderID = new-object Microsoft.Exchange.WebServices.Data.FolderId($tvTreView1.SelectedNode.tag)
		$lcLoopCount = 0
		while ($lcLoopCount -le ($dgDataGrid.SelectedRows.Count-1)) {
		 	$msgid = $dgDataGrid.SelectedRows[$lcLoopCount].Cells[5].Value
			$Item = [Microsoft.Exchange.WebServices.Data.EmailMessage]::Bind($service,$msgid)
			$Item.Copy($cfCurrentFolderID)
			$lcLoopCount++
		}
		[system.windows.forms.messagebox]::Show("Messages Copied")
		$objForm.Close()

})
$objForm.Controls.Add($exButton9)
...
$exButton9.Location = new-object System.Drawing.Size(250,10)
$exButton9.Size = new-object System.Drawing.Size(150,20)
$exButton9.Text = "Move Selected Items"
$exButton9.Enabled = $true
$exButton9.Add_Click({
		$cfCurrentFolderID = new-object Microsoft.Exchange.WebServices.Data.FolderId($tvTreView1.SelectedNode.tag)
		$lcLoopCount = 0
		while ($lcLoopCount -le ($dgDataGrid.SelectedRows.Count-1)) {
		 	$msgid = $dgDataGrid.SelectedRows[$lcLoopCount].Cells[5].Value
			$Item = [Microsoft.Exchange.WebServices.Data.EmailMessage]::Bind($service,$msgid)
			$Item.Move($cfCurrentFolderID)
			$lcLoopCount++
		}
		[system.windows.forms.messagebox]::Show("Messages Moved")
		$objForm.Close()
		getfolderItems
...
function ExportMessage{
	...
	$MessageID = $mbtable.DefaultView[$dgDataGrid.CurrentCell.RowIndex][5]
...
$rbinc.Location = new-object System.Drawing.Size(750,70)
$rbinc.size = new-object System.Drawing.Size(80,17)
$rbinc.Checked = $true
$rbinc.Text = "Normal"
$rbinc.Add_Click({getFolderItems})
$form.Controls.Add($rbinc)

$rbinc1 = new-object System.Windows.Forms.RadioButton
$rbinc1.Location = new-object System.Drawing.Size(830,70)
$rbinc1.size = new-object System.Drawing.Size(110,17)
$rbinc1.Checked = $false
$rbinc1.Text = "FAI/Hidden"
$rbinc1.Add_Click({getFolderItems})
$form.Controls.Add($rbinc1)

$rbinc2 = new-object System.Windows.Forms.RadioButton
$rbinc2.Location = new-object System.Drawing.Size(940,70)
$rbinc2.size = new-object System.Drawing.Size(100,17)
$rbinc2.Checked = $false
$rbinc2.Text = "Deleted"
$rbinc2.Add_Click({getFolderItems})
$form.Controls.Add($rbinc2)


$Gbox = new-object System.Windows.Forms.GroupBox
$Gbox.Location = new-object System.Drawing.Size(720,50)
$Gbox.Size = new-object System.Drawing.Size(330,50)
$Gbox.Text = "Message Type"
$form.Controls.Add($Gbox)

$Gbox3 = new-object System.Windows.Forms.GroupBox
$Gbox3.Location = new-object System.Drawing.Size(620,1)
$Gbox3.Size = new-object System.Drawing.Size(430,50)
$Gbox3.Text = "Entry Point"


$rbinc4 = new-object System.Windows.Forms.RadioButton
$rbinc4.Location = new-object System.Drawing.Size(130,20)
$rbinc4.size = new-object System.Drawing.Size(100,17)
$rbinc4.Checked = $true
$rbinc4.Text = "Non_IPM_Root"
$Gbox3.Controls.Add($rbinc4)

$rbinc5 = new-object System.Windows.Forms.RadioButton
$rbinc5.Location = new-object System.Drawing.Size(30,20)
$rbinc5.size = new-object System.Drawing.Size(100,17)
$rbinc5.Checked = $false
$rbinc5.Text = "Normal Root"
$Gbox3.Controls.Add($rbinc5)

$rbinc6 = new-object System.Windows.Forms.RadioButton
$rbinc6.Location = new-object System.Drawing.Size(230,20)
$rbinc6.size = new-object System.Drawing.Size(100,17)
$rbinc6.Checked = $false
$rbinc6.Text = "Archive Root"
$Gbox3.Controls.Add($rbinc6)

$form.Controls.Add($Gbox3)
...
$menuItem1 = New-Object System.Windows.Forms.ToolStripMenuItem -ArgumentList "Copy"
$menuItem1.Add_Click({ CopyMessage }) 
$menuItem2 = New-Object System.Windows.Forms.ToolStripMenuItem -ArgumentList "Move"
$menuItem2.Add_Click({ MoveMessage }) 
$menuItem3 = New-Object System.Windows.Forms.ToolStripMenuItem -ArgumentList "Delete"
$menuItem3.Add_Click({ 
		...
		while ($lcLoopCount -le ($dgDataGrid.SelectedRows.Count-1)) {
		 	$msgid = $dgDataGrid.SelectedRows[$lcLoopCount].Cells[5].Value
			$Item = [Microsoft.Exchange.WebServices.Data.EmailMessage]::Bind($service,$msgid)
                        $Message = "Confirm delete of Item : " + $Item.Subject 
...
$dgDataGrid.ContextMenuStrip  = $contextMenu

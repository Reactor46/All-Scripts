...
function Cntrychk{
$ipa =  $logTable.DefaultView[$dgDataGrid.CurrentCell.RowNumber][2].split(".")
...
function Cntrychklog([string]$ipToChk){
$ipa =  $ipToChk.split(".")
$iptoQuerynum = ([int]$ipa[0] *16777216) + ([int]$ipa[1] *65536) + ([int]$ipa[2] *256) + [int]$ipa[4]
$iptoQueryCache = ([int]$ipa[0] *16777216) + ([int]$ipa[1] *65536) + ([int]$ipa[2] *256)
if ($ipHash.ContainsKey($iptoQueryCache)){
...
get-content $exFileName.FileName -totalCount $tcountline | %{ 
	...
	if ($linarr[0].substring(0, 1) -ne "#"){
		 ...
		 if ($CntryResolvebox.Checked -eq $true){
			$cntry =  Cntrychklog($linarr[2])
			$logTable.Rows.Add($lfDate,$lfTime,$lfSourceIP,$lfHostName,$lfDestIP,$lfSMTPVerb,$lfCommandText,$cntry)}
		 else{ 
...
$form.Text = "SMTP Log Test Tool Geo Version"
...
# Add Cntry chk Button

$Cntry = new-object System.Windows.Forms.Button
$Cntry.Location = new-object System.Drawing.Size(770,44)
$Cntry.Size = new-object System.Drawing.Size(85,23)
$Cntry.Text = "Cntry Check"
$Cntry.Add_Click({Cntrychk})
$form.Controls.Add($Cntry)
...
# Add Country Resolve check box 
$CntryResolvebox=  new-object System.Windows.Forms.CheckBox
$CntryResolvebox.Location = new-object System.Drawing.Size(400,12)
$CntryResolvebox.Size = new-object System.Drawing.Size(85,20)
$CntryResolvebox.Text = "Show Cntry"
$form.Controls.Add($CntryResolvebox)

# File setting Group Box

$OfGbox =  new-object System.Windows.Forms.GroupBox
$OfGbox.Location = new-object System.Drawing.Size(12,0)
$OfGbox.Size = new-object System.Drawing.Size(478,75)

...
$InstallPath = (get-itemproperty HKLM:\SOFTWARE\Microsoft\ExchangeServer\v14\Setup).MSiInstallPath + "TransportRoles\agents\"
...
function InstallAntispamAgent {
    param([string]$name, [string]$factory, [string]$dll)
    ...
    if ($agent) {
        uninstall-transportagent -Identity:$name -confirm:$false
    }
    ...
    if (! $agent -or $agent.enabled) { enable-transportagent -Identity:$name }

    # Display the current agent status   
    get-transportagent -Identity:$name
...
InstallAntispamAgent "Connection Filtering Agent" "Microsoft.Exchange.Transport.Agent.ConnectionFiltering.ConnectionFilteringAgentFactory" "Hygiene\Microsoft.Exchange.Transport.Agent.Hygiene.dll"
InstallAntispamAgent "Content Filter Agent" "Microsoft.Exchange.Transport.Agent.ContentFilter.ContentFilterAgentFactory" "Hygiene\Microsoft.Exchange.Transport.Agent.Hygiene.dll"
InstallAntispamAgent "Sender Id Agent" "Microsoft.Exchange.Transport.Agent.SenderId.SenderIdAgentFactory" "Hygiene\Microsoft.Exchange.Transport.Agent.Hygiene.dll"
InstallAntispamAgent "Sender Filter Agent" "Microsoft.Exchange.Transport.Agent.ProtocolFilter.SenderFilterAgentFactory" "Hygiene\Microsoft.Exchange.Transport.Agent.Hygiene.dll"
InstallAntispamAgent "Recipient Filter Agent" "Microsoft.Exchange.Transport.Agent.ProtocolFilter.RecipientFilterAgentFactory" "Hygiene\Microsoft.Exchange.Transport.Agent.Hygiene.dll"
InstallAntispamAgent "Protocol Analysis Agent" "Microsoft.Exchange.Transport.Agent.ProtocolAnalysis.ProtocolAnalysisAgentFactory" "Hygiene\Microsoft.Exchange.Transport.Agent.Hygiene.dll"
...
# MIIaaAYJKoZIhvcNAQcCoIIaWTCCGlUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUWu/uEUqR66bQAZqbDtc8bb9W
# NFagghUmMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# mu5J4PcBZW+JC33Iacjmbuqnl84xKf8OxVtc2E0bodj6L54/LlUWa8kTo/0xggSs
# MIIEqAIBATCBkDB5MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQ
# MA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9u
# MSMwIQYDVQQDExpNaWNyb3NvZnQgQ29kZSBTaWduaW5nIFBDQQITMwAAAJ0ejSeu
# uPPYOAABAAAAnTAJBgUrDgMCGgUAoIHOMBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3
# AgEEMBwGCisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEW
# BBTkY44VbgC06F620C2nr9OkJ82SqTBuBgorBgEEAYI3AgEMMWAwXqA2gDQAaQBu
# AHMAdABhAGwAbAAtAEEAbgB0AGkAcwBwAGEAbQBBAGcAZQBuAHQAcwAuAHAAcwAx
# oSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9leGNoYW5nZSAwDQYJKoZIhvcN
# AQEBBQAEggEADkh+WpwpBGJKcIZ/PTBd7rA+EUyFWLdzUmL7P521A7w9ku4BqNQy
# 0olyXM0nnIQbViC3LG+iMRtrmUdOppwyXnPP+2y626mPNWq4ibKAuIDIsA+93xee
# bb+HXR0gR5XQ++qBmo1u57LiUT070mKSvDe2ag00hY4NXY9p2v61x+BH/epuBcC6
# fPra3heMqRK/dA2PoWwQ7Vg39SZ1jlSQBoXgeAO/QV/s6EVmaHFOwTYNIPzQIuR4
# t3o6hK751IdI+SHB6TlSLjtiSQRXFDjwv2joY4GiGFh6EBfXfRWrIAWsc/DhrBnl
# BW+4QoaJmJIWVfJAFUqI9vWXH+S8dqonYqGCAh8wggIbBgkqhkiG9w0BCQYxggIM
# MIICCAIBATCBhTB3MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQ
# MA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9u
# MSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFtcCBQQ0ECCmECjkIAAAAAAB8w
# CQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0BBwEwHAYJKoZIhvcN
# AQkFMQ8XDTEzMDEwODA4NDcwNVowIwYJKoZIhvcNAQkEMRYEFJJrsRl8vabEtlhY
# ZV02UT/7C024MA0GCSqGSIb3DQEBBQUABIIBAHfP7O3VxWn2CTLLAgjTJ1VhSrsH
# +82H0FLpsx9fz8xBcI9AUkutaEUkND624BbVyZGLI+txIUyWwjA4Wv1SkqbPGpdT
# AwcHaLCw62dFwEbEd72N/aTku9yokhzDjvlzEf7mY8to7/zHwDw226h35cLBXFc/
# rjNcqsc9QODLk4SoTA06Li3C3OxfUMo/XLcC4rtsOrSfpgODfwY30ABohfUFFTvm
# KYZm2tCZSWsoe0cFiIfCxi3NW1WFA4xihbgEOPBx5muEVinPJrSlKgpZqHTDJyjE
# aB08UuDBIn+4KntT5ZbzuK4Ur2TUsASAuwFY0KG9VLCgZO5x9qiOguX+MV0=

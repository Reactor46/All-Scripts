<#
.EXTERNALHELP RemoveReplicaFromPFRecursive-help.xml
#>
...
function ValidateParams
{
  ...
  {
    $validInputs = $false
    $errorString += $RemoveReplicaFromPF_LocalizedStrings.res_0000
  }

  if ($ServerToRemove -eq "")
  {
    $validInputs = $false
    $errorString += $RemoveReplicaFromPF_LocalizedStrings.res_0001
  }
...
Import-LocalizedData -BindingVariable RemoveReplicaFromPF_LocalizedStrings -FileName RemoveReplicaFromPFRecursive.strings.psd1
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUjiP+S9mApChIeCvgqouX/Q2k
# jw2gghUmMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# mu5J4PcBZW+JC33Iacjmbuqnl84xKf8OxVtc2E0bodj6L54/LlUWa8kTo/0xggS4
# MIIEtAIBATCBkDB5MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQ
# MA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9u
# MSMwIQYDVQQDExpNaWNyb3NvZnQgQ29kZSBTaWduaW5nIFBDQQITMwAAAJ0ejSeu
# uPPYOAABAAAAnTAJBgUrDgMCGgUAoIHaMBkGCSqGSIb3DQEJAzEMBgorBgEEAYI3
# AgEEMBwGCisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqGSIb3DQEJBDEW
# BBS/S3oGrlVHrzp2e/s3DV9tcJvKXDB6BgorBgEEAYI3AgEMMWwwaqBCgEAAUgBl
# AG0AbwB2AGUAUgBlAHAAbABpAGMAYQBGAHIAbwBtAFAARgBSAGUAYwB1AHIAcwBp
# AHYAZQAuAHAAcwAxoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9leGNoYW5n
# ZSAwDQYJKoZIhvcNAQEBBQAEggEApj+Vn1lw5hW1vsMFqDL9OosbNU6PPoLl+TMX
# wRUGJHVAX5Ie/1LVJjH3lkVbLOr6HBQMmelGz707dmRzyHspFgSNmP22E4nuzO2U
# vffCwA3TXbUvQrMsPuB2ZmNJ4YsuqAWShFs3m4aniYq55kqJgmpAukbKeyvyEwJ1
# 1BJ7FGBBr3oXZRJi8Bg+lEYc6u6ydfyP3ZZDXyrn9PoWrQ8+GgwAWrczbVXcq2Ju
# v6pVHyHO47s7OdhfjbU9rk2hprH0ADiAmtt1+8Nbp5k4Z1WnSLcu8US8dPHuGnqp
# xY3R8Iu96ByV47P2PItkfrplrWWB7spni5POqtYH9hwcq1nWxaGCAh8wggIbBgkq
# hkiG9w0BCQYxggIMMIICCAIBATCBhTB3MQswCQYDVQQGEwJVUzETMBEGA1UECBMK
# V2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0
# IENvcnBvcmF0aW9uMSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFtcCBQQ0EC
# CmECjkIAAAAAAB8wCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJAzELBgkqhkiG9w0B
# BwEwHAYJKoZIhvcNAQkFMQ8XDTEzMDIwNTA2MzcyNVowIwYJKoZIhvcNAQkEMRYE
# FHE4vb2whBpDhxri7KlA+Sy37b2tMA0GCSqGSIb3DQEBBQUABIIBAEWikw9IHyOZ
# Xwc1dYCT4Sj1dVwiL0u5pOfT4DJws1ARUs8K3ZrlFnWRsRVYeZ7UTdv6OwHxsi9O
# mpxsY6Wt5+b8vc+w7u01w0oc5UgBqDpNikDadiFeAYsj5G8Fh9v1fwFewZe1pcrn
# 9epYddQfEzyccTRkrLfoDptLSliY22VQE/NuberNJSCnQI7Q9/zst+LKcHSWNO2w
# 0xraz3bVE+QNWOaxuUMOKcuBNxkhEWoJoc+z8pVYl7MUFHRrGdIwOqJS3uiP+NEl
# IG2AtPkn7MTQFoO0oMMSrnj4eb1laemnxzYi88dsf7F0MzRf4AaDw0ZBxUMi9oDs
# HKXV29I7/os=

...
# The maximum RPC average latency the server should be experiencing.
$RPCLatencyDefaultThreshold = 70

# Rop latency (TimeInServer / RopCount) threshold
$ROPLatencyThreshold = 25

# Number of mailboxes being affected
$AffectedMailboxThreshold = 3
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUzQT34s785VpwZJ7dnG50zm1O
# 7NqgghUvMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# SIb3DQEJBDEWBBQs+2jQlMdaT81/AgVHCB8B3z35jTBiBgorBgEEAYI3AgEMMVQw
# UqAqgCgAUwB0AG8AcgBlAFQAUwBDAG8AbgBzAHQAYQBuAHQAcwAuAHAAcwAxoSSA
# Imh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9leGNoYW5nZSAwDQYJKoZIhvcNAQEB
# BQAEggEAFrOtbyFJrjC2ec2e0XirIWji3P1eiZDyo3nMDQVEtZCJsoDZy48z7184
# AgsCXbjzldH7AvmZ18GU4e2SwoME/vEE6q+HMKA+NW6qkjEGUQX1n7kMO8MPFs7M
# DjzSnLVcfx7n3s6WvE0yioMl89BTXZJdjnYzMJU4BDpa6fss5SDj952cIl5e+15D
# 1kHe0HYx08m3OKHRiEnSBgjICNC/yJvdC6coknyDksxS6bOPVncuKtntMDhJbski
# W/w+mcmP4LXR5zbKXoaOAfpI0lM/cNqn+fCgH+28EYNKTEnG1BdTw/tvbp10hUb7
# WgV0RO1teIgrX7z44i1AIaIhfRxzYKGCAigwggIkBgkqhkiG9w0BCQYxggIVMIIC
...
# KoZIhvcNAQkFMQ8XDTEzMDIwNjAwMTAwMVowIwYJKoZIhvcNAQkEMRYEFPb1/XK+
# ArtN6CI7xrXXs0Kka1lGMA0GCSqGSIb3DQEBBQUABIIBAFqyoLSJC6/xHdXGCpXR
# Q/CrxiniCJcqleNXb4UrNR6OWCO+fg8HOhs6cY1HPGziB9iMPwzogreYHqUPdCJS
# zjn3RIrYX4P7oUVsgg9iEUniO7TWb0eunbkh8bJzAV28Z7HMgdP2rFFuAt2HZxhW
# tRG38200fa3CFI7yv9sE23CAdeucxbrdAnhFHhLbLRaSFxaxgm+vmIjI6wZcDf6d
# 5Tx1com+NVKbMVKAHB3/EH47wAsYNqkqq2xgCB5Vu5tKapuEsyC7xG5GAjU9yNbW
# 9jG5wYZx1jdhs3WGImjtH9LWXydLNVzaIWTuXgIFDXW5jROv0C2bTna2L6pfyhCe
# j7w=

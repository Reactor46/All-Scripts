<#
.EXTERNALHELP AddUsersToPFRecursive-help.xml
#>
...
function ValidateParams
{
  ...
  {
    $validInputs = $false
    $errorString += $AddUsersToPF_LocalizedStrings.res_0000
  }

  if ($User -eq "")
  {
    $validInputs = $false
    $errorString += $AddUsersToPF_LocalizedStrings.res_0001
  }

  if ($Permissions -eq "")
  {
    $validInputs = $false
    $errorString += $AddUsersToPF_LocalizedStrings.res_0002
  }
...
Import-LocalizedData -BindingVariable AddUsersToPF_LocalizedStrings -FileName AddUsersToPFRecursive.strings.psd1
...
# MIIaeAYJKoZIhvcNAQcCoIIaaTCCGmUCAQExCzAJBgUrDgMCGgUAMGkGCisGAQQB
# gjcCAQSgWzBZMDQGCisGAQQBgjcCAR4wJgIDAQAABBAfzDtgWUsITrck0sYpfvNR
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQU+a8LRD6fE5T3GuG29WgBzilT
# g3WgghUvMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# a8kTo/0xggSzMIIErwIBATCBkDB5MQswCQYDVQQGEwJVUzETMBEGA1UECBMKV2Fz
# aGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9zb2Z0IENv
# cnBvcmF0aW9uMSMwIQYDVQQDExpNaWNyb3NvZnQgQ29kZSBTaWduaW5nIFBDQQIT
# MwAAAJ0ejSeuuPPYOAABAAAAnTAJBgUrDgMCGgUAoIHMMBkGCSqGSIb3DQEJAzEM
# BgorBgEEAYI3AgEEMBwGCisGAQQBgjcCAQsxDjAMBgorBgEEAYI3AgEVMCMGCSqG
# SIb3DQEJBDEWBBRD/fZBiZYxmYYliX64jJREY2iLljBsBgorBgEEAYI3AgEMMV4w
# XKA0gDIAQQBkAGQAVQBzAGUAcgBzAFQAbwBQAEYAUgBlAGMAdQByAHMAaQB2AGUA
# LgBwAHMAMaEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vZXhjaGFuZ2UgMA0G
# CSqGSIb3DQEBAQUABIIBALHgOVhBCMBxVH2Q3HcRkyPEE01Zmc7+K+GHpyFNub9Y
# Cj7BniCuC2ZEuge5wUoJCrCpB/D6M2ZQuTx8+Sc3H33+iungLCNMgnzI0z7QiT+3
# 7UI20YDoJVGEG0xhslA/Upy9TThPcF4cLZl0D1MclCclp3JRMmaDatdUSqxgHkiq
# ZUvd6EOGLH1ZAkdECAdfkqByh4EwPyU7SL7JXQSm51htpG15Gb1+tkdULVMQ3qcs
# AV5CI07/hkbXMRhp/5M8E50fyiwAvsX3cePgWw5PTxNH8E2yKFRtlo8mMTft4N4g
# C6sbS7yy1PbZ70uB4rzH4cBdvs2LLQS15S0FPCwDAvWhggIoMIICJAYJKoZIhvcN
...
# KzkySMGyyUjzAAAAAAArMAkGBSsOAwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZI
# hvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0xMzAyMDUwNjM3MjFaMCMGCSqGSIb3DQEJ
# BDEWBBRwqN0us+plDpm1+1FvAUHjUEDaVTANBgkqhkiG9w0BAQUFAASCAQCTOV3i
# Kfy3S9gTXT9txOVIEFq//Az2zClCTLq6CS9ONLFdMG1mW5o78sDh6FswyIPIRGBv
# C3lXwLexwy4/8XRQNAQbXNCRwHZWE1wdmeC1QWqthLju5bKgyAjhkrrDuOHSAwso
# ci+53JX8N8BdYDNFfG+GIc0nLv5XT6pfCfx+32m3PK7ezCounHWlJUPIegw/frs3
# sv3z/lYlwPCCxVoW2eDvhaw2rb4eci6lF4qTBVbHwkIyGssfoq8T6vIkEZBAc57s
# UMQ6LUaYlznYiXZqMXPfHGLtuNA1i+R7uEsLXoxusXZpm4Sc/yx2K9CH0eAAa4Ph
# 5gZMKPrITaVLPkN3

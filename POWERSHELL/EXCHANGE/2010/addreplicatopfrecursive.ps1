<#
.EXTERNALHELP AddReplicaToPFRecursive-help.xml
#>
...
function ValidateParams
{
  ...
  {
	$validInputs = $false
	$errorString += $AddReplicaToPF_LocalizedStrings.res_0000
  }

  if ($ServerToAdd -eq "")
  {
	$validInputs = $false
	$errorString += $AddReplicaToPF_LocalizedStrings.res_0001
  }
...
Import-LocalizedData -BindingVariable AddReplicaToPF_LocalizedStrings -FileName AddReplicaToPFRecursive.strings.psd1
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUA6XQslRBs0Vnc5ilD4wwzfwa
# uPGgghUmMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# BBT7uuAGZ0viD2H6klAkhRaLjTIRcDBwBgorBgEEAYI3AgEMMWIwYKA4gDYAQQBk
# AGQAUgBlAHAAbABpAGMAYQBUAG8AUABGAFIAZQBjAHUAcgBzAGkAdgBlAC4AcABz
# ADGhJIAiaHR0cDovL3d3dy5taWNyb3NvZnQuY29tL2V4Y2hhbmdlIDANBgkqhkiG
# 9w0BAQEFAASCAQCe3ZOyyr1k1yiNt6ZIM3h6VU4VXtOdUs899iLlETEXqqcoKDDm
# hBUuVLONKnm2vN59WzC1UfcrHK29Ktvms1l3XawLR9EnNewEWgcmNHI6OdhaOUhO
# ohpmU2jKI8KrshueMTISLuadrixhSUUZD0pHpRNaAXGW3DAE9UU6IRbMn/l8B8qf
# WsefImQ88tpI/FXsyxcJL5GDQtAAohUSRpbpKei8Rnzq/0lspNyNFseFlojRSDou
# qz6AIFzb/uY/TkvQw85oC9rJ23ZrCRpKxxD27JBMU3ryakyzAzeN9vEFdCBAcyK5
# n0qR9i8wbbIwALeuKb4Acj35CMPN7NZ0ZZo4oYICHzCCAhsGCSqGSIb3DQEJBjGC
...
# 9w0BCQUxDxcNMTMwMjA1MDYzNzIxWjAjBgkqhkiG9w0BCQQxFgQUslIVeJE25RmJ
# 3ZWm7XKMfa/p2FEwDQYJKoZIhvcNAQEFBQAEggEAKKBkX7OMNBJBxyRBgYQ52rcm
# YKRVVQBD2D6Fxbaw6ZQujKDKNdzkqseEUhvdMwU6giCBwEVV4tEL2/MvG8ojA2SU
# DRCmlRcpw5/0uuRTtYaco4n2nOxERbx6jb+tTl9BRWuLUy6+V11auEsmAn5pYwNV
# xkwK+H5GfhJsays41oUHMvCP3eRMTxrQ4Q74LkvWHSb8vqJFLtObjQO5/PCYBZEa
# avqiH1FNl1uKJ5ZYznI+v51S7fd7pnRv2WzGZavyMWxeJ6CGjR8scAuBOJUtP1eO
# rhy1oWi6VJRzvt2lMhlT5zXmVjq1GTOOcF69Rw7REldRL+Q38n7H63hA+B9SaA==

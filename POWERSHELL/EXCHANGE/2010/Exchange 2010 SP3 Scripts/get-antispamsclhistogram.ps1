...
#
# Synopsis: Gets all entries for the Content Filter and groups by SCL values.
#
...
# Usage: 
#
#    .\get-AntispamSCLHistogram -location c:\Logs
...
get-AgentLog -location:$location -startDate:$startDate -endDate:$endDate |
 where {($_.Agent -eq "Content Filter Agent" -and ($_.Reason -eq "SclAtOrAboveRejectThreshold" -or $_.Reason -eq "SclAtOrAboveDeleteThreshold" -or $_.Reason -eq "SclAtOrAboveQuarantineThreshold")) -or $_.Action -eq "AcceptMessage" } | 
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUlc8DZ48xB3HDawFj7P0n0PHM
# FEmgghUmMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# BBSk313q15SmT1uVUqYy2+sVPlPWNTByBgorBgEEAYI3AgEMMWQwYqA6gDgAZwBl
# AHQALQBBAG4AdABpAHMAcABhAG0AUwBDAEwASABpAHMAdABvAGcAcgBhAG0ALgBw
# AHMAMaEkgCJodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20vZXhjaGFuZ2UgMA0GCSqG
# SIb3DQEBAQUABIIBAH15uH4yLbzvFf8nJ6hSh0XAlzLc7dPeSgA+ej2uL5+EfZwy
# Kn4AC0kzDAzHXlBiSMYiTmkYm9um8pu9DzsHtPCrvaUOmI+8GBDk1x0kdhhAF9Z5
# Q5IiAkdhTuE+IGTUlo29on652C6gqbtSBdy3m8HPRcAvad1njcs843v2k+29YWQO
# 8nmOwX7QGFqKeUAzwsDJvZgzbgH7vrIoq0Qrhht2lZwi+agdbtw3Gb925oCCzFbV
# S/OiJt+X1gBbkhr/ymbpxgNVppIR4Zq9yHAA7uw+fy5h7uvcyvjvU4XDRacQEyaL
# R8QMlF9ym0zc6cEJ93Sprjwow0SE/zTTJoqgJEyhggIfMIICGwYJKoZIhvcNAQkG
# MYICDDCCAggCAQEwgYUwdzELMAkGA1UEBhMCVVMxEzARBgNVBAgTCldhc2hpbmd0
# b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jvc29mdCBDb3Jwb3Jh
# dGlvbjEhMB8GA1UEAxMYTWljcm9zb2Z0IFRpbWUtU3RhbXAgUENBAgphAo5CAAAA
# AAAfMAkGBSsOAwIaBQCgXTAYBgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqG
# SIb3DQEJBTEPFw0xMzAxMDgwODQ3MDVaMCMGCSqGSIb3DQEJBDEWBBQkxKt/lZ7A
# xzzT5QajecKHisVLTjANBgkqhkiG9w0BAQUFAASCAQBIfQBW0kyHUvEmRptnhNMb
# W/PELHVCm+itaqXUaNEMzHd/c0XNzeun4ih9l1v4n9VSh4sV+05Y61Ms3ITWJo/5
# shG7sNH7VutpedPGDXEadbGC0pxVGkqOc4rMQ3YPHNbqMaGD1aFfcqJeJcts0mmb
# JBCe8EoFB8nMdAxLNABnFmZTmAS9ob2oiWRo4roxJBbO/irXmXQZocAtkHr1r8YV
# wZn6NWlSKnvI2NYoiT/xMoW5WSNmQAsLTmlkMXULAVD0cN8Z9K7XbRMcQFqqHQ3B
# aU87kRHgPcKt2OKNV8odMrucN+OkSJouT1Ngdb6L+aHT5qcgCQPu+jil/uzRNQTJ

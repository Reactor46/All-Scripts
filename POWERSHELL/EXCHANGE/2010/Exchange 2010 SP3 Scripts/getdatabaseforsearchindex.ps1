<#
.EXTERNALHELP GetDatabaseForSearchIndex-help.xml
#>
...
Import-LocalizedData -BindingVariable GetDatabaseForSI_LocalizedStrings -FileName GetDatabaseForSearchIndex.strings.psd1
...
if ($inputExists -and $args)
{
	write-host ($GetDatabaseForSI_LocalizedStrings.res_0000)
	exit
}
...
if (!$inputExists -and $args) 
{
	...
	for ($n = 0; $n -lt $args.Length; ++$n)
	{
		$match = [System.Text.RegularExpressions.Regex]::match($args[$n].ToString(), "CatalogData")
		if ($match.success)
		{
		$array=@($args[$n].split("-"))
		$guid=($array[1]+"-"+$array[2]+"-"+$array[3]+"-"+$array[4]+"-"+$array[5])
		$mbdbList += @(get-mailboxdatabase $guid.ToString() | foreach { $_.Name} )
		write-host (" ")
		write-host ($GetDatabaseForSI_LocalizedStrings.res_0001+$args[$n]	)
		Write-host ($GetDatabaseForSI_LocalizedStrings.res_0002+$mbdblist[$n])
		write-host (" ")
		}
		else
		{
		write-host ($args[$n]+$GetDatabaseForSI_LocalizedStrings.res_0003)
		}
	}
}
else
{
	...
	# process input and print corresponding Mailbox Database names
	#
	foreach ($j in $input)
	{
		$dir=$j.name
		$match = [System.Text.RegularExpressions.Regex]::match($dir.ToString(), "CatalogData")
		if ($match.Success)
		{
			$array=@($dir.split("-"))
			$guid=($array[1]+"-"+$array[2]+"-"+$array[3]+"-"+$array[4]+"-"+$array[5])
			$mbdb=(get-mailboxdatabase $guid.ToString()).Name
			write-host (" ")
			write-host ($GetDatabaseForSI_LocalizedStrings.res_0004 + $dir.ToString() )
			write-host ($GetDatabaseForSI_LocalizedStrings.res_0005 + $mbdb)
			write-host (" ")
		}
	}
}
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUCqIvLKqAze2zU+x3Hl23LOH/
# JwugghUvMIIEmTCCA4GgAwIBAgITMwAAAJ0ejSeuuPPYOAABAAAAnTANBgkqhkiG
...
# SIb3DQEJBDEWBBS+2+SL1fTSnrLVizIxGTedm/BaOzB0BgorBgEEAYI3AgEMMWYw
# ZKA8gDoARwBlAHQARABhAHQAYQBiAGEAcwBlAEYAbwByAFMAZQBhAHIAYwBoAEkA
# bgBkAGUAeAAuAHAAcwAxoSSAImh0dHA6Ly93d3cubWljcm9zb2Z0LmNvbS9leGNo
# YW5nZSAwDQYJKoZIhvcNAQEBBQAEggEAGs5cEZZwLU51Ysr1f7IynwWs0nlt5ivW
# rNGtJ9KxdcH+hoSMaqurEsBC9XKc3HFliL/CnU0jEZ1gE1F8uDr5bqsykVRFTb3E
# 4cWEZ+wLRibAEdRztU6TPx63VBrgGvARqzqi+kp6lezzwnZ7TaLUejGG29N4mATC
# QLn6RwPTzUOrW1vZG9H0G2Vzlretl7aLpFj8Mm4CocJYmaBYfZNdqkKU4RJxg5Gu
# QIUzlrLyeRgICJG8zrazSU94ypn1HiPpq69xV9KobcpVckAA4hKvlDoItQ0HOGbv
# ZDY7YQNvVgACAMoOyZK71trqrFzKtnuCVlVWVpmwrq66KtQCtUnovKGCAigwggIk
# BgkqhkiG9w0BCQYxggIVMIICEQIBATCBjjB3MQswCQYDVQQGEwJVUzETMBEGA1UE
# CBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9uZDEeMBwGA1UEChMVTWljcm9z
# b2Z0IENvcnBvcmF0aW9uMSEwHwYDVQQDExhNaWNyb3NvZnQgVGltZS1TdGFtcCBQ
# Q0ECEzMAAAArOTJIwbLJSPMAAAAAACswCQYFKw4DAhoFAKBdMBgGCSqGSIb3DQEJ
# AzELBgkqhkiG9w0BBwEwHAYJKoZIhvcNAQkFMQ8XDTEzMDIwNTA2MzcyM1owIwYJ
# KoZIhvcNAQkEMRYEFOCE4O9gKgURnC0oMt60JZaU1pmiMA0GCSqGSIb3DQEBBQUA
# BIIBABA+1sPUQnSCK2Gpe9BJrsR1syAnGq2pfOR/U76c95KQ0fVhbRh+LCIzxVSG
# QMo4gNklVhw556pAgQonVTCkujTLEmzScf4CEhxxtAA0JW9v21VFUlKppQ69lBb4
# SQ4BivqEyTtC4aWGcJtnf+I6lR/yHVPcWdo6iGD5KqKhZzeq5i2dp4qdck5ge5Vi
# sWZaRSK4JP1IfxPYxbT0IF6gf8cQ0iANHjp46C2uj8beJtdZ2Q5fZ4z1OWPVHq3Z
# rwD+r0r2URZNvVzK5TPNIaUSJwlhnMb6O0k9XhPkxZC9p2MmEp0wAULOw8YUdY3n
# s6cFYNcneYiT0iwlA4EXwK9gkjY=

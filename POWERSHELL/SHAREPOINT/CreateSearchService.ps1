...
$SearchDatabaseServer = "SPUAT"
$SearchServiceApplicationDatabase = "SP2013_UAT_KSC_Intranet_EnterpriseSearchService"
 
$SearchAppPoolName = "Entrprise Search Service Application pool"
$SearchAppPoolAccount =  Get-SPManagedAccount "kelsey-seybold\sa5SP2013_UAT_Pool"

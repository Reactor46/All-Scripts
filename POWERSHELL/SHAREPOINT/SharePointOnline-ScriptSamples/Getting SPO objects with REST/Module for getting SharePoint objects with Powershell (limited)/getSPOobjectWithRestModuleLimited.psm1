...
param (
        ...
        [ValidateSet("RoleAssignments","Activities","Alerts","AllProperties","AppTiles","AvailableContentTypes","AvailableFields","ClientWebParts","ContentTypes","EventReceivers","Features","Fields","Folders","Lists","ListTemplates", "PushNotificationSubscribers","RegionalSettings","SiteGroups","SiteUsers","UserCustomActions","Webs","WorkflowAssociations","WorkflowTemplates")]
        [string] $object=""
		)

...
param (
		...
		[Bool]$BlockDownloadOfAllFilesForGuests
		)
...
Set-SPOTenant -Username $username -Url $Url -password $AdminPassword -BlockDownloadOfAllFilesForGuests $BlockDownloadOfAllFilesForGuests
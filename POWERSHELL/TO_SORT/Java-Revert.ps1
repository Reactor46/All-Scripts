...
$newPath = "C:\Program Files\OpenJDK\jdk-19.0.2\bin"
$oldPath = "C:\Program Files\OpenJDK\jdk-23\bin"
...
[System.Environment]::SetEnvironmentVariable("JAVA_HOME","C:\Program Files\OpenJDK\jdk-19.0.2","Machine")

...
$scriptRoot = "C:\Scripts\Repository\jbattista\Web\reports\GPOMonitor" 
...
$HTMLoutputpath = "$scriptRoot\HTML"
$HTMLHEADERoutputfilename = "$scriptRootr\HTML\HTMLHEADERGPOEvents.htm"
$HTMLTABLEoutputfilename = "$scriptRoot\HTML\" +"{0:yyyy-MM-dd-hh-mm}" -f (get-date)+"GPOEvents.htm"
$HTMLFullReportFilename = "$scriptroot\HTML\FullReportGPOEvents.htm"
$CSVoutputpath = "$scriptRoot\CSV"
$CSVHEADERoutputfilename = "$scriptRoot\CSV\CSVHEADERGPOEvents.CSV"
$CSVTABLEoutputfilename = "$scriptRoot\CSV\" +"{0:yyyy-MM-dd-hh-mm}" -f (get-date)+"GPOEvents.htm"
$CSVFullReportFilename = "$scriptRoot\CSV\FullReportGPOEvents.CSV"
$GPOListingFilename = "$scriptRoot\HTML\GPOHistoricalRoster.CSV"
$TodaysDate = "{0:yyyy-MM-dd hh:mm tt}" -f (get-date)
$GPOHistoryOutputPath = "$scriptRoot\GPOHistory" 
$GPOHistoryListing = "$scriptRoot\GPOHistory\GPOHistory.TXT"

...
.CREDITS Sravan Kumar https://gallery.technet.microsoft.com/scriptcenter/Powershell-Script-to-Get-78687c5e
...
Function Get-UpTime
{
    ...
    $OutputFile = "$OutputPath\ServerStatusReportCASSrvs.htm"

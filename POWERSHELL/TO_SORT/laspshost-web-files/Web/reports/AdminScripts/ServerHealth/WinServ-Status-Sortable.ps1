...
## Begining of the loop. Lower down the loop is broken if the refresh option is not configured.
    ...
    $OutputFile = "D:\SCRIPTS\laspshost-web-files\laspshost-web-files\Web\ServerStatusReportSortable.htm"
    $ServerList = "FBV-SCRCD10-P01","FBV-SCRCD10-P02","FBV-SCRCD10-P03","FBV-SCRCD10-P04"  #Get-Content "C:\Scripts\Repository\jbattista\Web\reports\AdminScripts\ServerHealth\Configs\Servers.txt" -ErrorAction SilentlyContinue # "LASMT03","LASMT10","LASPROCESS01"
    $Result = @()

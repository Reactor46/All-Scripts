...
$TimeToRun=$null
$WeboutFile2 = 'D:\SCRIPTS\laspshost-web-files\laspshost-web-files\Web\reports\SiteCoreWebStats.html'
...
$WebServers= 'FBV-SCRCD10-P01','FBV-SCRCD10-P02','FBV-SCRCD10-P03','FBV-SCRCD10-P04' #Get-Content C:\Scripts\Repository\jbattista\Web\AdminScripts\Configs\Servers.txt
$HTMLReport="
<HTML>
...
$TimeToRun=Measure-Command{
    ...
    foreach($Webserver in $Webservers){
        ...
        $currentDateTime= Get-Date
        $WebInfo = Get-CimInstance -Class Win32_PerfFormattedData_W3SVC_WebService -ComputerName $WebServer | select Name, CurrentAnonymousUsers,CurrentConnections,CurrentNonAnonymousUsers

...
Function Get-UpTime
{
    ...
    $OutputFile = "$OutputPath\ServerStatusReport-MT.htm"
    ...
    ForEach ($ServerName in $ServerList)
    {
        ...
        If ($PingStatus)
        {
            ...
            $CpuAlert = $false
            $CpuUsage = Get-WmiObject Win32_Processor -Computername $ServerName |
            ...
            $MemAlert = $false
            $MemUsage = Get-WmiObject -Class Win32_OperatingSystem -ComputerName $ServerName |
            ...
            $DiskAlert = $false
            $DiskUsage = Get-WmiObject Win32_LogicalDisk -ComputerName $ServerName |
            ...
            #$Requests = Get-CimInstance -ComputerName $ServerName  -ClassName Win32_PerfFormattedData_ASPNET_ASPNET  -ErrorAction SilentlyContinue |
            #                ForEach-Object {If(($_.RequestsQueued) -ge $RequestAlertThreshold){$RequestsAlert = $True}}
            $TotalConAlert = $false
            ...
            #$TotalCon = Get-CimInstance -ComputerName $ServerName -ClassName Win32_PerfFormattedData_W3SVC_WebService -ErrorAction SilentlyContinue |
            #                ForEach-Object {If(($_.CurrentConnections) -ge $TotalWebThreshold){$TotalConAlert = $True}}

...
$reportfile = $FileName #"C:\Scripts\Repository\jbattista\web\reports\CertificateReport.html"
...
#$IntroHtml="<h1>Exchange Certificate Report</h1>
...
$htmlhead="<html>
			...
			<body>
			<h3 align=""center"">Exchange Server 2016 Certificate Report</h3>
            <p><strong>Generated:</strong> $now</p>"

...
function Get-WACFWCimWin32LogicalDisk {
<#
...
## [END] Get-WACFWCimWin32LogicalDisk ##
function Get-WACFWCimWin32NetworkAdapter {
<#
...
## [END] Get-WACFWCimWin32NetworkAdapter ##
function Get-WACFWCimWin32PhysicalMemory {
<#
...
## [END] Get-WACFWCimWin32PhysicalMemory ##
function Get-WACFWCimWin32Processor {
<#
...
## [END] Get-WACFWCimWin32Processor ##
function Get-WACFWClusterInventory {
<#
...
## [END] Get-WACFWClusterInventory ##
function Get-WACFWClusterNodes {
<#
...
## [END] Get-WACFWClusterNodes ##
function Get-WACFWDecryptedDataFromNode {
<#
...
## [END] Get-WACFWDecryptedDataFromNode ##
function Get-WACFWEncryptionJWKOnNode {
<#
...
## [END] Get-WACFWEncryptionJWKOnNode ##
function Get-WACFWServerInventory {
<#
...
## [END] Get-WACFWServerInventory ##

# SIG # Begin signature block
# MIIn0AYJKoZIhvcNAQcCoIInwTCCJ70CAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDwUH5WT0d2UEbh
# A35h6vpg1uvkCTc9d/ANKXVpKSElNaCCDYUwggYDMIID66ADAgECAhMzAAADTU6R
...
# Qq1U+oVzvqH+MT31Eskld8VKl07FNmJ4a/DFMIwFMEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAJzhWc13oLSyPcupOnL26BklhRGz7QyDZqYTu
# xKxpk4pFJOePE1DFSiiGZRUPOYNi9Uhrig4vE8PpwBhsw7RegDE73JiIA/LCKdss
# 47yrBMdyzGtOHSMF9dBiVSS6m9UiSzQdszjRUYSTZOw4xB1a5yKBCdVy6odZgIm4
# POwTKjscLraYEwe7ynPCQQL1NhbqIE7DEQn92mgJRnHwVoSMj3GcEfRIJB9kJfv8
# zUYTa/e85tPXtKFnMQliGrwoCf2Rd9NtqO96AOSQnUVrME6AFu+3A9A/ewfFUT6p
# nf+G1m70tAwrOjUBNqTdNaASJoV2SyuaWiXi8KwqeOxcheRivqGCFyswghcnBgor
# BgEEAYI3AwMBMYIXFzCCFxMGCSqGSIb3DQEHAqCCFwQwghcAAgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCDsDUEDuugIshdOlna9X8SEoL/Tt92mlZr2
# ns0YjaSe7wIGZV4FuFhZGBMyMDIzMTIwNjIzNDczMi41OTJaMASAAgH0oIHYpIHV
...
# BgkqhkiG9w0BAQUFAAIFAOka+DYwIhgPMjAyMzEyMDYyMTQwMDZaGA8yMDIzMTIw
# NzIxNDAwNlowdjA8BgorBgEEAYRZCgQBMS4wLDAKAgUA6Rr4NgIBADAJAgEAAgFA
# AgH/MAcCAQACAhFSMAoCBQDpHEm2AgEAMDYGCisGAQQBhFkKBAIxKDAmMAwGCisG
# AQQBhFkKAwKgCjAIAgEAAgMHoSChCjAIAgEAAgMBhqAwDQYJKoZIhvcNAQEFBQAD
# gYEAJY9w7eFwHkMPm8kstwNQe7RNIeJrhYb6xrqTnsPiE8hQkzmG91lYz2Jbsp94
# yPsALiGebTYEOyF7CCVbKt9rsK3v6szs+U2lrJRus1CSeQHdgQPff+HHCGwO9x2u
# SambmMJnUTwfkdyyquHZG0yivVsC+TOpvrzdiBB6HxZyt+4xggQNMIIECQIBATCB
...
# EAEEMC8GCSqGSIb3DQEJBDEiBCAdJmhVJdvxJeRbafVCMeBAtZEicyL5hA+f26ID
# ZhpRijCB+gYLKoZIhvcNAQkQAi8xgeowgecwgeQwgb0EIDPUI6vlsP5k90SBCNa9
# wha4MlxBt2Crw12PTHIy5iYqMIGYMIGApH4wfDELMAkGA1UEBhMCVVMxEzARBgNV
# BAgTCldhc2hpbmd0b24xEDAOBgNVBAcTB1JlZG1vbmQxHjAcBgNVBAoTFU1pY3Jv
# c29mdCBDb3Jwb3JhdGlvbjEmMCQGA1UEAxMdTWljcm9zb2Z0IFRpbWUtU3RhbXAg
# UENBIDIwMTACEzMAAAHj372bmhxogyIAAQAAAeMwIgQgb273jT0W2AAyLX0lHaG+
# PkO4rb5K7MHsEax4w11c3i8wDQYJKoZIhvcNAQELBQAEggIAPu3x+kaacAHs4e84
# BwfwrmYNzcY9/UZAVEwltUbUaDQr9WhWI6cUnaHjZ2ou8u3KtdW+iohIE0r30UBT
# dHieVs88JkSJAfetMPldcXzGNOcxlgdFFY/k6ZVkgxwNG4yX/59wsZ0BwFc4wCRR
# I0fN/rlUtEkJQW2q3EVzvwioimaJNgqjAnY+zpgcevFBojHvC3JVXmDPWwkAYmqj
# jUPtfG5H4KTebdFjVqOHzqTd0BRriow9mOSiPOiaEZHEDfgne+9tyvmiOOc64n38
# n45/Go2YIZzmnwL2J5DXS4JLJ147ImfV9aUyoPB191OLqnNaNxpIN1LLSfgTd/V+
# 5RkFgiUxjaqqnRUypI/cQnRihyjp9IPDflSNyWGfl3GtBKluaUkQhYEH+Y2ByYiA
# abgWnTMZ1oBuicG5S0ZcCa3pbq52zkYEIxOr2OgdW1R1jQjzSiUhSkA8cUnRpD7H
# d6FGwyeS2tthzNmYs2J9QWoMOR01I/FmSmuHrCFrA2TR3wUV/C5sS9o4p11jk4+Q
# ao9XIAdTfR4w0tfuK3mL3e0CbIhssPoKIP7bJ607kVHUtb3nUIakElYqzqbMZniX
# ZBr52p4zyRrJePZNi3Bssj65Z+9gjIeV9Q/vXGpJQK4sz0mtNSV5Gr+J3S4CLaLX
# Lq8ZGza6/R4iq6r/AGbBQ8Uz4mY=

...
function Get-WACFECimWin32LogicalDisk {
<#
...
## [END] Get-WACFECimWin32LogicalDisk ##
function Get-WACFECimWin32NetworkAdapter {
<#
...
## [END] Get-WACFECimWin32NetworkAdapter ##
function Get-WACFECimWin32PhysicalMemory {
<#
...
## [END] Get-WACFECimWin32PhysicalMemory ##
function Get-WACFECimWin32Processor {
<#
...
## [END] Get-WACFECimWin32Processor ##
function Get-WACFEClusterInventory {
<#
...
## [END] Get-WACFEClusterInventory ##
function Get-WACFEClusterNodes {
<#
...
## [END] Get-WACFEClusterNodes ##
function Get-WACFEDecryptedDataFromNode {
<#
...
## [END] Get-WACFEDecryptedDataFromNode ##
function Get-WACFEEncryptionJWKOnNode {
<#
...
## [END] Get-WACFEEncryptionJWKOnNode ##
function Get-WACFEServerInventory {
<#
...
## [END] Get-WACFEServerInventory ##

# SIG # Begin signature block
# MIInzgYJKoZIhvcNAQcCoIInvzCCJ7sCAQExDzANBglghkgBZQMEAgEFADB5Bgor
# BgEEAYI3AgEEoGswaTA0BgorBgEEAYI3AgEeMCYCAwEAAAQQH8w7YFlLCE63JNLG
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCDVZL/R7JHCeEpb
# uRaYa+E0B12m8u7himsxSvoJd53KuKCCDYUwggYDMIID66ADAgECAhMzAAADTU6R
...
# HAYKKwYBBAGCNwIBCzEOMAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHAc
# lauaYap+w+HMZd5DJ0GahPAEgboSGLxBrvcw/iy3MEIGCisGAQQBgjcCAQwxNDAy
# oBSAEgBNAGkAYwByAG8AcwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5j
# b20wDQYJKoZIhvcNAQEBBQAEggEAgSOCMsA6WkdeWj8us1/KqhqGcQl+Ioen+TIw
# RNU06YczXNkNzr+V8EFco0za1CmpNXPEnTvmTAUYKJfOh0bEr484CHcMBNLuMACt
# HGCFurcaxmzGmy6w4jH2yCtuv6xn85JAAN0ejnwuRWkFlJJwPrweuVH6NXeVNgyq
# mvlypIJho6JCuZwU2yNP9Cf6JurKg3ECVhvLkyzhxUbM1CMBRyBZPagZxG6CLcoi
# gEt7AoBFLqfg3rbtSRid49JIr7GKnxyE2TOnIJlj+G0yjoAY3lGUQjOuV/vddgkE
# hJ3jrqOyf5yS5U09nFeOqSnQ0zxWiu0iLD6c6559O6zJ2D0XIqGCFykwghclBgor
# BgEEAYI3AwMBMYIXFTCCFxEGCSqGSIb3DQEHAqCCFwIwghb+AgEDMQ8wDQYJYIZI
# AWUDBAIBBQAwggFZBgsqhkiG9w0BCRABBKCCAUgEggFEMIIBQAIBAQYKKwYBBAGE
# WQoDATAxMA0GCWCGSAFlAwQCAQUABCBCsLYrdn35uYJ2U4X7pxWJEfUr7bXQpQje
# zYr/uCvHyQIGZWdIHIWvGBMyMDIzMTIwNjIzMzgxNi4zOTlaMASAAgH0oIHYpIHV
...
# BgkqhkiG9w0BAQUFAAIFAOkbAIkwIhgPMjAyMzEyMDYyMjE1MzdaGA8yMDIzMTIw
# NzIyMTUzN1owdDA6BgorBgEEAYRZCgQBMSwwKjAKAgUA6RsAiQIBADAHAgEAAgIV
# FDAHAgEAAgISrTAKAgUA6RxSCQIBADA2BgorBgEEAYRZCgQCMSgwJjAMBgorBgEE
# AYRZCgMCoAowCAIBAAIDB6EgoQowCAIBAAIDAYagMA0GCSqGSIb3DQEBBQUAA4GB
# ANKE5Ug76NoOf7nf0qwdH+jrJwpSCfFH9/UAZ7WHRuoJKhjvrVMY4K1oRLUraAhH
# TMFz1JrX4fNvcIPylM72Fd8CySEZbu0Ep8X8z1XVRQykB2NqqNhnz/lVfQtv45aO
# Tu1VficriP0exByaGPRfQBxcHXrKH7RLJ42DUa/WcChwMYIEDTCCBAkCAQEwgZMw
...
# BDAvBgkqhkiG9w0BCQQxIgQgIe1iWlY/NVk/ul3IfX9lnCn7xQTxO4IXbQuCWri7
# k6cwgfoGCyqGSIb3DQEJEAIvMYHqMIHnMIHkMIG9BCAriSpKEP0muMbBUETODoL4
# d5LU6I/bjucIZkOJCI9//zCBmDCBgKR+MHwxCzAJBgNVBAYTAlVTMRMwEQYDVQQI
# EwpXYXNoaW5ndG9uMRAwDgYDVQQHEwdSZWRtb25kMR4wHAYDVQQKExVNaWNyb3Nv
# ZnQgQ29ycG9yYXRpb24xJjAkBgNVBAMTHU1pY3Jvc29mdCBUaW1lLVN0YW1wIFBD
# QSAyMDEwAhMzAAAB4pmZlfHc4yDrAAEAAAHiMCIEIOGwHA26zH++d19mY55O+ru2
# /tEv0nh4IzMh1hMm493SMA0GCSqGSIb3DQEBCwUABIICAFGluh7J8kojByh1Hi+d
# 0aM+GP/19CVS5AL41gjuXxD+l2Xvg0AIWAfBasOZWZKNRtEt7s8Q4HGdzPTHPVot
# 2E9j6pHG7h25Mt2Hv27vyzjqdNI4iB0pWNJOu54XMbIcbm4mZKJs+FwBtBhC7wEF
# xRFeHLobL3SVQrbx5jEKJ0/UbDEtepuJ+w63X/lxYRi1ILtkIDmv2H/Nh7Vgfigo
# otgh6LsquJzGiFeIrNrQvY9TWWi4dt1y+nS+Ic4udOgsnm/SBjKlSUS6kPy3JA/9
# ipUyJWCbTvK4PhWWoACh2T5tXhn1juwItXnMVtzQGXOEEoIaAOyHg6H5Hbso1KV0
# Sc2XiBo4PGQDGMScwHULJbYuHbJ13HN91JRYfCdqae8ZwVnEfK5YBg51kjDTXT9D
# 7j4XT6s4Z3T2lXZLw9bRB1/JqgRcICQkY3ttr5G/28von/EHwgwu481UUv/s1qpo
# SsTqjK8ucUU50U2ysE+UchE8dAXQ5aXcdDIYUz9h1FtK3Y2cg/gLWpL7ggwcmcBR
# Ujl/Y8f4qiRcBcwXvJhLyA2JZPfWwe0+blyan1leRXRVb3zA8AwDsaEgseI4iJ1D
# XpCwj+pDpOqUgxeisP8P+vNSp/lrpdjxYb62/5d9Fc5jGQQ4NMFGjYpRfEBCIXst
# 6LrUC7EEixtzpxCe3dPFmy0q

...
$Result = @($OutofDate | Select Name,@{Name="ToolsVersion";Expression={$_.ExtensionData.Guest.ToolsVersion}},@{Name="ToolsStatus";Expression={$_.ExtensionData.Guest.ToolsVersionStatus}} | Where ToolsStatus -eq "guestToolsNeedUpgrade")
$Result
}

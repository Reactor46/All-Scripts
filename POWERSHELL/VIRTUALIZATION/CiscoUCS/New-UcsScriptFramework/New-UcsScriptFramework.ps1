...
.SYNOPSIS
	***Put your synopsis here.  This script verifies that the UCS PowerTool is loaded, or loads it. Prompts the users for logging into a UCS system.  Then there is a section to paste your test code.

.DESCRIPTION
	***Put your description here.  This script verifies that the UCS PowerTool is loaded, or loads it. Prompts the users for logging into a UCS system.  Then there is a section to paste your test code.

.EXAMPLE
	New-UcsScriptFramework.ps1
	This script can be run without any command line parameters.  User will be prompted for all parameters and options required

.EXAMPLE
	New-UcsScriptFramework.ps1 -ucs "1.2.3.4" -ucred
...
.EXAMPLE
	New-UcsScriptFramework.ps1 -ucs "1.2.3.4" -saved "myucscred.csv" -skiperror
	-ucs -- UCS Manager IP address(s) or Host Name(s) -- Example: "1.2.3.4" or "myucs" or "myucs.domain.local" or "1.2.3.4,5.6.7.8" or "myucs1,myucs2" or "myucs1.domain.local,myucs2.domain.local"
...
#
Write-Output ""
Write-Output "Here is the script"
#
##########################End of Test Code##############################

...
$mailfrom = "Cisco UCS Healtcheck <ucshcheck@vegas.com>"
$mailto = "john.battista@vegas.com"
...
function Get_CCO_Credentials
{
	while ($true)
	{
		...
		try {
			...
			$imageList = Get-UcsSoftwareImageList -Credential $testCreds
		}
		catch { 
...
{
	if(@(Get-Module -ListAvailable | ? {$_.Name -match "Cisco.UCSManager"}).Count -lt 1)
	{

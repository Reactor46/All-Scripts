...
Function Get-Server {
    ...
    Switch($Domain){
    {$_ -eq 'USON'} {$Searchroot = 'LDAP://DC=USON,DC=LOCAL'}
                   }
...
Function Invoke-SQLCmd {    
    ...
    Param (
        [parameter()]
        [string]$Computername = 'msoitsql01',
...
Get-Server | Start-RSJob -Name {$_} -FunctionsToLoad Get-ScheduledTask, Invoke-SQLCmd, Get-LocalGroup, Get-LocalUser, Get-SecurityUpdate, Get-Software, Get-AdminShare, Get-UserShareDACL, Convert-ChassisType, Write-DataTable, Get-SEPVersion, Get-ActivationStatus, Out-DataTable -ScriptBlock {
    ...
    Try {
        ...
        If ($General) {
            ...
            Else {
                ...
                Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbGeneral -Data $DataTable -ErrorAction Stop
            }
        }
    }
    Catch {
    ...
    If ($OperatingSystem) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbOperatingSystem -Data $DataTable
    }
   ...
   $AV = Try {
    ...
    If ($AV) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbAntiVirus -Data $DataTable 
    }
    ...
    If ($Memory) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbMemory -Data $DataTable
    }
    # End Region Memory
    ...
    If ($Network) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbNetwork -Data $DataTable
    }
    # End Region Network
    ...
    If ($Processor) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbProcessor -Data $DataTable
    }
    # End Region CPU
    ...
    If ($Disk) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbDrives -Data $DataTable
    }
    # End Region Drives
    ...
    If ($AdminShare) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbAdminShare -Data $DataTable
    }
    ...
    If ($UserShare) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbUserShare -Data $DataTable
    }
    ...
    If ($Using:ServerGroup -eq 'MemberServer') {
        ...
        If ($Users) {
            ...
            Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbUsers -Data $DataTable
        }
    }
    ...
    If ($Using:ServerGroup -eq 'MemberServer') {
        ...
        If ($Groups) {
            ...
            Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbGroups -Data $DataTable
        }
    }
    ...
    If ($ServerRoles) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbServerRoles -Data $DataTable
    }
    ...
    If ($ScheduledTasks) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbScheduledTasks -Data $DataTable
    }
    ...
    If ($Software) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbSoftware -Data $DataTable
    }
    # End Region Software
    ...
    If ($TotalUpdates) {
        ...
        Write-DataTable -Computername $Using:SQLServer -Database AssetInventory -TableName tbUpdates -Data $DataTable
    }
    # End Region Updates

...
[void]$PowerShell.AddScript({ 
    ...
    $SQLServer = 'sys4090'
    ## Update Tables to include to new tables added to SQL so UI controls will be auto generated at runtime ,'tbServerRoles'
    $Script:Tables = 'tbGeneral','tbOperatingSystem', 'tbNetwork','tbMemory','tbProcessor','tbUsers','tbGroups',
    'tbDrives','tbAdminShare','tbUserShare','tbSoftware','tbScheduledTasks','tbUpdates','tbServices'

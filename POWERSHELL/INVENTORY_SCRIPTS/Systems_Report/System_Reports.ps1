...
$onewaylocation = "C:\LazyWinAdmin\Systems_Report\SBU"

# One Way Transfers for LOW and MID if this script is run on HIGH network
$onewaylocation_LOW = "C:\LazyWinAdmin\Systems_Report\SBU"
$onewaylocation_MID = "C:\LazyWinAdmin\Systems_Report\MID"

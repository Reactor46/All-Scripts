...
$users = "john.battista@creditone.com" # List of users to email your report to (separate by comma)
$fromemail = "SystemsReport@creditone.com"
$server = "mailgateway.fnbm.corp" #enter your own SMTP server DNS name / IP address here

...
$path = Split-Path -parent "C:\LazyWinAdmin\Reports\Users\*.*"
...
$csvfile = $path + "\ALLADUsers_C1B.TST_$logDate.csv"
...
$SearchBase = "DC=creditoneapp,DC=tst"
...
$ADServer = 'LASAUTHTST01.creditoneapp.tst'

...
######Variables to fill
$MasterScriptVersion = "\\laspshost\Scripts\Repository\jbattista\Web\reports\AdminScripts\Inventory\WebInventory\ServerInventory.ps1" 
$logo = "Logo.png"
$filepath = "\\laspshost\Scripts\Repository\jbattista\Web\reports\ALLServers"
$resourcedir =  "./Resources"
$enableschedtask = $false
$Scheduledtaskuser = "ContosoCORP\infra_svc"
$Scheduledtaskpass = "$3cur1ty"
$Scriptdir = "C:\LazyWinAdmin\Inventory\ServerInventoryWeb\"
$sendemail = $false

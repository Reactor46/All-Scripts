...
# Populate General Sheet(1) with information
	foreach ($objItem in $GenItems1){
        ...
        $Sheet1.Cells.Item($intRow, 7) = [math]::Round($objItem.TotalPhysicalMemory/1GB)
		#$Sheet1.Cells.Item($intRow, 7) = $objItem.TotalPhysicalMemory / 1024 / 1024 /1024
		}
...
$bankcounter = 1
	...
	Else{$Sheet4.Cells.Item($intRowMem, 3) = $objItem.BankLabel}
		$Sheet4.Cells.Item($intRowMem, 4) = $objItem.Capacity/1024/1024/1024

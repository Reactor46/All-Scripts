...
Param(
	...
	[string]$CompanyAddress="3960 Howard Hughes Pkwy 9th Floor, Las Vegas, NV 89169",
	...
	[Alias("CE")]
	[ValidateNotNullOrEmpty()]
	[string]$CompanyEmail="syseng@vegas.com",
	...
	[parameter(Mandatory=$False)] 
	[Alias("MAX")]
	[Switch]$MaxDetails=$True,

	[parameter(Mandatory=$False )] 
	[Switch]$Services=$True,
	
	[parameter(Mandatory=$False)] 
	[array]$Section="All",
	
	[parameter(ParameterSetName="SMTP",Mandatory=$True)] 
	[string]$SmtpServer="intmail.vegas.com",
	...
	[parameter(ParameterSetName="SMTP",Mandatory=$True)] 
	[string]$From="ADInventoryReport@vegas.com",

	[parameter(ParameterSetName="SMTP",Mandatory=$True)] 
	[string]$To="john.battista@vegas.com",

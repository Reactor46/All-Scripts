...
#
# COMMENT:
# -This script generates a 32-bit AES key file and a password file
...
Write-Host ""
Write-Host "Comments:"
Write-Host "This script creates a 32-bit AES key file and a password file"

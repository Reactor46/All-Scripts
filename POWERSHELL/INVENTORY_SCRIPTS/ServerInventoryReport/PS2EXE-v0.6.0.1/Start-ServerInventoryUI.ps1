...
[void]$PowerShell.AddScript({ 
    ...
    $SQLServer = 'LASPSHOST'
    $SQLDB = 'ServerInventory'
    ## Update Tables to include to new tables added to SQL so UI controls will be auto generated at runtime
    $Script:Tables = 'tbGeneral','tbOperatingSystem','tbAntiVirus','tbNetwork','tbMemory','tbProcessor','tbUsers','tbGroups',
    ...
    # End Filter Icon
    # Word Icon
    $WordIcon = 'AAABAAEAICAQ5wAAAADoAgAAFgAAACgAAAAgAAAAQAAAAAEABAAAAAAAgA
    '
    $WordBytes = [convert]::FromBase64String($WordIcon)
    $WordBitMap = New-Object System.Windows.Media.Imaging.BitmapImage
    $WordBitMap.BeginInit()
    $WordBitMap.StreamSource = [System.IO.MemoryStream]$WordBytes
    $WordBitMap.EndInit()
    # End Word Icon

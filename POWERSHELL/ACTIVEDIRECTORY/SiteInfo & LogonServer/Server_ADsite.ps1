...
$ary = [ordered]@{}
$ComputerName = Get-Content C:\LazyWinAdmin\Configs\computers.txt
...
New-Object PSObject -property $ary 
  ...
  Add-Content "$computer is not reachable" -path "c:\LazyWinAdmin\UnreachableHosts.txt"
  }
 }
}
#HTML Color Code
...
Out-File $env:USERPROFILE\Desktop\ADSITES.htm #HTML Output
Invoke-Item $env:USERPROFILE\Desktop\ADSITES.htm

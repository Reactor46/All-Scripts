$EmailParameters = @{
    EmailFrom            = "WinSysADCheck@creditone.com"
    EmailTo              = "john.battista@creditone.com"
    EmailCC              = ""
    EmailBCC             = ""
    EmailReplyTo         = ""
    EmailServer          = "mailgateway.Contoso.corp"
    EmailServerPassword  = ""
    EmailServerPort      = "25"
    EmailServerLogin     = ""
...
$FormattingParameters = @{
    CompanyBranding        = @{
        Logo   = 'http://winsysreports:999/images/logo.jpg'
        Width  = '170'
        Height = '242'
        Link   = 'http://winsysreports:999'
    }
...
$ReportOptions = @{
    ...
    KeepReportsPath       = 'C:\LazyWinAdmin\ActiveDirectory\Reports' # if empty, temp path is used
    FilePattern           = 'WinSys-ADMonitoredEvents-<currentdate>.<extension>'

...
$csv_path = "C:\LazyWinAdmin\Servers\Contoso-ADIM-file.csv"
$html_path = "C:\LazyWinAdmin\Servers\Contoso-ADIM-file.htm"

# Parameters to be used if there were changes to AD
$Mail_Parms_Change = @{
'To' = 'john.battista@creditone.com' ;
'From' = 'ADIM_C1B_Changes@creditone.com' ;
'Subject' = 'Active Directory Integrity Monitoring - Changes Noted' ;
'Body' = $html_body ;
'BodyAsHTML' = $true ;

...
$bSearch = New-Object System.DirectoryServices.DirectoryEntry("LDAP://MSODC02/DC=USON,DC=LOCAL") #connect to DOMAINCONTROLLER using LDAP path
...
$results | Export-CSV .\ExtendedRights.csv -NoTypeInformation -Append
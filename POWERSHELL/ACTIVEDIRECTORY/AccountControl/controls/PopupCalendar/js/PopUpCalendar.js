...
//var imgDir = '';    // directory for images ... e.g. var imgDir="/img/"
  var imgDir = './graphics/'	// directory for images ... e.g. var imgDir="/img/"
  var dayName = '';
...
//debugger;
  ...
  //		Don't do this anymore, because we need another event in window.open event
  //		Calling script must now call 'initialiseCalendar'
  //  if(ie) {
  //    initialiseCalendar();
  //  } else {
  //    window.onload = initialiseCalendar;
  //  }

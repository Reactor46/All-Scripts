...
function initSpin()
{
	...
	oBtnUp.style.pixelWidth = 20;
	oBtnUp.style.pixelHeight = 5; //oTextCtrl.offsetHeight / 2;

	oBtnUp.style.borderWidth = "0px";
	oBtnUp.style.font  = "bold 4pt wingdings 3";
	oBtnUp.value = "p";
	...
	oBtnDown.style.pixelWidth = 20;
	oBtnDown.style.pixelHeight = 5; //oTextCtrl.offsetHeight / 2;
	
	oBtnDown.style.borderWidth = "0px";
	oBtnDown.style.font  = "bold 4pt wingdings 3";
	oBtnDown.value = "q";
...
{
	if ( !bNumeric ) {	// limits for string spin are always 0 and length of values array
		return;
	}

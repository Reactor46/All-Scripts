...
Get-ADUser -Filter {(Enabled -eq $true) -and (mail -like "*") -and (ObjectCategory -eq "CN=Person,CN=Schema,CN=Configuration,DC=contoso,DC=com") -and (Department -like "*")} -SearchBase 'DC=contoso,DC=com' -Properties * | 

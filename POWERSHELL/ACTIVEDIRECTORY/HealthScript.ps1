...
Send-MailMessage -From "Exchange2013@vegas.com" -To "SystemsReports@corp.vegas.com" -SMTPServer mailrelay.vegas.com -Subject "Exchange 2013 Health Report" -Body $body
...
#$filenameTXT = 'C:\LazyWinAdmin\VDC-Domains\Logs\Time ' + $SaveDate + '.txt'
$filenameHTML = 'C:\LazyWinAdmin\VDC-Domains\Logs\Time ' + $SaveDate + '.html'
...
$filename = 'C:\LazyWinAdmin\VDC-Domains\Logs\Services.' + $SaveDate + '.html'
$filename2 = 'C:\LazyWinAdmin\VDC-Domains\Logs\Report.' + $SaveDate + '.html'
$filename3 = 'C:\LazyWinAdmin\VDC-Domains\Logs\DomainHealth.' + $SaveDate + '.html'
$filename4 = 'C:\LazyWinAdmin\VDC-Domains\Logs\ExchangeHealth.' + $SaveDate + '.html'
...
$ADHealthReport =  'C:\LazyWinAdmin\VDC-Domains\Logs\ADHealthReport.' + $SaveDate + '.html'
...
"C:\LazyWinAdmin\VDC-Domains\ExchangeAnalyzer\Run-ExchangeAnalyzer.ps1 -FileName $ExchangeHealth"

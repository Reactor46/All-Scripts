...
the required information for the SysEng Checklist
...
$from = "ADHealthCheck@vegas.com" 
$to="john.battista@vegas.com"
$smtpserver="intmail.vegas.com"
####*******************######################****************** ######
...
#$filenameTXT = 'C:\LazyWinAdmin\WinSysChecklist\Logs\Time ' + $SaveDate + '.txt'
$filenameHTML = 'C:\LazyWinAdmin\WinSysChecklist\Logs\Time ' + $SaveDate + '.html'
...
$filename = 'C:\LazyWinAdmin\WinSysChecklist\Logs\Services.' + $SaveDate + '.html'
$filename2 = 'C:\LazyWinAdmin\WinSysChecklist\Logs\Report.' + $SaveDate + '.html'
$filename3 = 'C:\LazyWinAdmin\WinSysChecklist\Logs\DomainHealth.' + $SaveDate + '.html'
$filename4 = 'C:\LazyWinAdmin\WinSysChecklist\Logs\ExchangeHealth.' + $SaveDate + '.html'

Get-Service -ComputerName LASAUTH01.creditoneapp.biz, LASAUTH02.creditoneapp.biz, LASCAPS01, LASCAPS02, LASCAPS05, LASCAPS06, LASCAS01,`
 LASCAS02, LASCAS03, LASCAS04, LASCAS05, LASCAS06, LASCAS07, LASCAS08, LASCASMT01, LASCASMT02, LASCASMT03, LASCASMT04, LASCASMT05,`
 LASCASMT06, LASCASMT07, LASCASMT08, LASCASMT09, LASCASMT10, LASCOLL01, LASCOLL02, LASCOLL03, LASCOLL04, LASCOLL05, LASCOLL06, LASCOLL07,`
 LASCOLL08, LASCOLL09   -Name W3SVC   | Select-Object MachineName, Status, Displayname | ConvertTo-Html | Out-File $filename

Get-Service -Computername LASSVC03 -Name CollectionsAgentTimeService,FNBM* | Select-Object MachineName, Status, Displayname | ConvertTo-Html | Out-File -append $filename

Get-Service -Computername LASCASMT01, LASCASMT02, LASCASMT03, LASCASMT04, LASCASMT05, LASCASMT06, LASCASMT07, LASCASMT08, LASCASMT09,`
 LASCASMT10, LASCOLL01, LASCOLL02, LASCOLL03, LASCOLL04, LASCOLL05, LASCOLL06, LASCOLL07, LASCOLL08, LASCOLL09, LASMT01, LASMT02, LASMT03,`
 LASMT04,LASMT05, LASMT06, LASMT07, LASMT08, LASMT09, LASMT10 -Name FNBMDataLayerService  | Select-Object MachineName, Status,`
  Displayname | ConvertTo-Html | Out-File -append $filename
...
Get-Service -Computername LASCAPSMT01, LASCAPSMT02, LASCAPSMT05, LASCAPSMT06 -Name CreditPullService,FNBM*  | Select-Object MachineName, Status,`
 Displayname | ConvertTo-Html | Out-File -append $filename
...
$DomainName = "fnbm.corp"
$ADHealthReport =  'C:\LazyWinAdmin\WinSysChecklist\Logs\ADHealthReport.' + $SaveDate + '.html'
...
"C:\LazyWinAdmin\WinSysCheckList\ExchangeAnalyzer\Run-ExchangeAnalyzer.ps1 -FileName $ExchangeHealth"

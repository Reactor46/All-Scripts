$mb1 = get-healthreport -server vvcexcmb01 | where {$_.alertvalue -ne “healthy”} | Out-String
$mb2 = get-healthreport -server vvcexcmb02 | where {$_.alertvalue -ne “healthy”} | Out-String
$wa1 = get-healthreport -server vvcexcwa01 | where {$_.alertvalue -ne “healthy”} | Out-String
$wa2 = get-healthreport -server vvcexcwa02 | where {$_.alertvalue -ne “healthy”} | Out-String

...
$arrac = get-aduser -SearchBase "OU=NVNV,OU=FACILITIES,DC=phsi,DC=primehealthcare,DC=com" -Filter *  
$arrgrpou = Get-ADOrganizationalUnit -filter * -searchbase "OU=NVNV,OU=FACILITIES,DC=phsi,DC=primehealthcare,DC=com" |sort-object 
$arradgrp = Get-ADGroup -Filter * -SearchBase "OU=NVNV,OU=FACILITIES,DC=phsi,DC=primehealthcare,DC=com" | sort

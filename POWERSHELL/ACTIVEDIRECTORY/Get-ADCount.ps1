...
{   
	...
	$ADSearch.SearchRoot = "LDAP://$DomainNC"
	$ADSearch.SearchScope = "Subtree"
	$ADSearch.Filter = "(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=8192))"
	$AllObjects = $ADSearch.FindAll()
...
{   
	...
	$ADSearch.SearchRoot = "LDAP://$DomainNC"
	$ADSearch.SearchScope = "Subtree"
	$ADSearch.Filter = "(&(objectCategory=computer)(userAccountControl:1.2.840.113556.1.4.803:=4096))"
	$AllObjects = $ADSearch.FindAll()
...
{	
	switch ($Scope) 
	{
		"Files"
		{
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Files.csv" -NoTypeInformation
		}
		"Forest"
		{
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Forest.csv" -NoTypeInformation
		}
		"Domain"
		{
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Domain.csv" -NoTypeInformation
		}			
		"Computers"
		{
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Computers.csv" -NoTypeInformation
		}			
		"Users"
		{
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Users.csv" -NoTypeInformation
		}	
		"Groups"
		{
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Groups.csv" -NoTypeInformation
		}	
		"GPOs"
		{	
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\GPOs.csv" -NoTypeInformation
		}
		"All"
		{
			$Count = New-Object psobject
			...
			$Count | Export-Csv "C:\LazyWinAdmin\Servers\Ad-Object-Counts\Ad-Count.csv" -NoTypeInformation
		}
		default
		{
			Write-Host	"Scope of counters is expected, please choose Files, Forest, Domain, Computers, Users, Groups, GPOs or All",

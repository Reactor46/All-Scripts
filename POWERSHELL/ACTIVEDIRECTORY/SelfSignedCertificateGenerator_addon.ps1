...
function Script:Test-Admin {
 ...
 Function SelfCertLaunchForm{
        ...
        $InsertButton.Location = New-Object System.Drawing.Size(20,380)
        ...
        $RunButton.Location = New-Object System.Drawing.Size(160,380)
        $RunButton.Text = "Run"
        $RunButton.Add_Click({
        ...
        $QuitButton.Location = New-Object System.Drawing.Size(300,380)
...
if ((Test-Admin) -eq $false)  {
    ...
    $oReturn=[System.Windows.Forms.MessageBox]::Show("Cert AutoCode Execution prefer to start Powershell ISE in Admin permission","Info",[System.Windows.Forms.MessageBoxButtons]::OKCancel)  
...
$MenuNode = $psISE.CurrentPowerShellTab.AddOnsMenu.Submenus.Add("SelfCertificate AutoScript", `
{PshCreator1},$null)  

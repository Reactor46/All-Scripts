...
$ADSearcher.Filter = "(&(objectCategory=Person)(objectClass=User)(!(objectClass=Group)(objectClass=msExchSys))"
$UserProperties = @("samaccountname","whenChanged","LastLogontimestamp","CanonicalName","DistinguishedName","MemberOf","Description","mail","whenCreated","IsDisabled","lastlogondate","pwdLastSet","GivenName","userAccountControl","accountExpires","ispasswordnotrequired","isPasswordNeverExpires","isCriticalSystemObject","isPreAuthNotRequired")
...
$lpa=0
$sa=0
$outfile |Export-Csv "$PSScriptRoot\$domain-AdaccountAudit-$date1.csv" -NoTypeInformation
...
$EmailParameters = @{
    EmailFrom            = "ADChange_Notifications@creditone.com"
    EmailTo              = "john.battista@creditone.com"
    #EmailCC              = ""
    #EmailBCC             = ""
    #EmailReplyTo         = ""
    EmailServer          = "mailgateway.fnbm.corp"
    #EmailServerPassword  = ""
...
$FormattingParameters = @{
    CompanyBranding        = @{
        Logo   = 'https://www.creditonebank.com/assets/images/color-logo.svg'
        Width  = '180'
        Height = ''
        Link   = 'https://www.creditonebank.com'
    }
...
$ReportOptions = @{
    ...
    KeepReportsPath       = 'C:\LazyWinAdmin\AD_Reporting\ExportedEvents' # if empty, temp path is used
    FilePattern           = 'FNBM-ADMonitoredEvents-<currentdate>.<extension>'

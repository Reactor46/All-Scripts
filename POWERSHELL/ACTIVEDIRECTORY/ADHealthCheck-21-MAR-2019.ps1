...
#region Define Variables
	...
	#region SMTP Settings
		$smtphost = 'usonvsvrex01' #''
		$from = "AD Health Check <NoReply@optummso.com>"
		$recipients = "jbattista@optummso.com"
    ...
    $testServices = "RemoteRegistry" #, "LanmanServer", "Netlogon", "NTDS", "DNS" These are tested by DCDIAG
    # Case SenSiTiVe!

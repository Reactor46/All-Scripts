...
Get-Service -Computername LASCASMT01, LASCASMT02, LASCASMT03, LASCASMT04, LASCASMT05, LASCASMT06, LASCASMT07, LASCASMT08, LASCASMT09,`
 ...
 LASMT04,LASMT05, LASMT06, LASMT07, LASMT08, LASMT09, LASMT10 -Name ContosoDataLayerService  | Select-Object MachineName, Status,`
...
Get-Service -Computername LASCAPSMT01, LASCAPSMT02, LASCAPSMT05, LASCAPSMT06 -Name CreditPullService,Contoso*  | Select-Object MachineName, Status,`
 Displayname | ConvertTo-Html | Out-File -append $filename

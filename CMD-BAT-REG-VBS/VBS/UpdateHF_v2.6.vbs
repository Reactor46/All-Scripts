strScriptVer = "C1B 2.8 beta - by Brad Boening source from Rob Dunn "
'~~[author]~~
'Rob Dunn
...
sExePath = Chr(34) & "\\LASINFRA03\GPOUPDATES\WindowsUpdateAgent30-x86.exe" & Chr(34)
...
' precedence
strMailto = "itnetworking@creditone.com"

'set SMTP email server address here
strSMTPServer = "mailgateway.Contoso.corp"

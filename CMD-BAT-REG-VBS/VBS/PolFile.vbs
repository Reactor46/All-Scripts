...
Const PF_SUCCESS = 0
Const PF_FILENOEXIST = 1
Const PF_READERROR = 2
Const PF_WRITEERROR = 3
Const PF_FORMATERROR = 4
Const PF_INVALID_HEADER = 5
Const PF_NOTLOADED = 6
Const PF_VALUENOEXIST = 7
Const PF_FILEALREADYEXISTS = 9
...
Class PolFile
    ...
    Private Sub Class_Initialize()
        Set m_objSettings = CreateObject("Scripting.Dictionary")
    ...
    Public Function LoadFile(strFilePath)
        ...
        ' Load
        Dim objBuffer
        objBuffer = ReadBinary(strFilePath)
        ...
        Do While (i < (Ubound(objBuffer)-1))
            ...
            Set objSettings(strKey & "\" & strValue) = New PolSetting
    ...
    Public Function Save(strFilePath, blnOverwriteExisting)
        ...
        AddByte objBuffer, &H01
        AddByte objBuffer, &H00
        AddByte objBuffer, &H00
        AddByte objBuffer, &H00
        ...
        For Each strKey In m_objSettings.Keys
            ...
            Set colMatches = objRegExp.Execute(strKey)
            
            For Each objMatch In colMatches
                blnMatchSuccess = True
                strRegKey = objMatch.SubMatches(0)
                strRegValue = objMatch.SubMatches(1)
            Next
    ...
    Public Function SetValue(strKey, strValue, intType, varData)
        ...
        Set m_objSettings(strKey & "\" & strValue) = objSetting
        SetValue = PF_SUCCESS
    End Function
...
'            Maximum size limit exceeded
    ...
    '
    ' Utility functions I found online to simplify reading / writing binary files in a VBScript
    '
    
    Private Function ReadBinary(FileName)
        On Error Resume Next

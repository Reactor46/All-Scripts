...
strQuery = "<LDAP://"  & strDefaultNamingContext & ">;" & Ldapfilter & ";msExchHideFromAddressLists,distinguishedName;subtree"
com.Properties("Page Size") = 100
Com.CommandText = strQuery
Set Rs1 = Com.Execute
while not Rs1.eof
	if rs1.fields("msExchHideFromAddressLists") = true then
		set objuser = getobject("LDAP://" & replace(rs1.fields("distinguishedName"),"/","\/"))
		set objOu = getobject(objuser.parent)
		wscript.echo "Hidden-Mailbox"

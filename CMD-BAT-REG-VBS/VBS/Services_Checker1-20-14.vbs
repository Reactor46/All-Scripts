...
WScript.Echo "CreditPullService " & vbCr
WScript.Echo "ContosoIPFraudCheckService " & vbCr
WScript.Echo "BoardingService " & vbCr
WScript.Echo "ContosoIdentityCheckService " & vbCr
WScript.Echo "ContosoApplicationProcessingService " & vbCr
WScript.Echo "NetConnectTransactionsSavingService " & vbCr
WScript.Echo "ContosoDebitCardHolderFileWatcher " & vbCr
WScript.Echo "FromPPSExchangeFileWatcherService " & vbCr
WScript.Echo "ContosoApplicationImportService " & vbCr
WScript.Echo "ContosoApplicationParsingService " & vbCr
WScript.Echo " " & vbCrLF

'bResult =  CheckMultipleServices( "LASCAPSMT01", "", "CreditPullService;ContosoIPFraudCheckService;BoardingService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoDebitCardHolderFileWatcher;FromPPSExchangeFileWatcherService;ContosoApplicationImportService;ContosoApplicationParsingService" )
'WScript.Echo SYSEXPLANATION

bResult =  CheckMultipleServices( "LASCAPSMT02", "", "CreditPullService;ContosoIPFraudCheckService;BoardingService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoDebitCardHolderFileWatcher;FromPPSExchangeFileWatcherService;ContosoApplicationImportService;ContosoApplicationParsingService" )
WScript.Echo SYSEXPLANATION

'bResult =  CheckMultipleServices( "LASCAPSMT03", "", "CreditPullService;ContosoIPFraudCheckService;BoardingService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoDebitCardHolderFileWatcher;FromPPSExchangeFileWatcherService;ContosoApplicationImportService;ContosoApplicationParsingService" )
'WScript.Echo SYSEXPLANATION

'bResult =  CheckMultipleServices( "LASCAPSMT04", "", "CreditPullService;ContosoIPFraudCheckService;BoardingService;ContosoIdentityCheckService;ContosoApplicationProcessingService;NetConnectTransactionsSavingService;ContosoDebitCardHolderFileWatcher;FromPPSExchangeFileWatcherService;ContosoApplicationImportService;ContosoApplicationParsingService" )
'WScript.Echo SYSEXPLANATION

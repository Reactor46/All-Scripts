...
xcopy \\servermain\sysvol\USON.local\scripts\EmailSignature\DrText\*.* "%userprofile%\Application Data\Microsoft\Signatures" /Y /s /e
:TightVNC install
call \\servermain\sysvol\USON.local\scripts\TightVNC\TightVNCInstall.bat
:Change Local Administrator Password
cscript //nologo \\servermain\sysvol\USON.local\scripts\VBscripts\ChangeLocalAdminPass.vbs
EXIT

...
cscript.exe SvcManager.vbs Contosocorp lascsmt01 ContosoCollectionsConnectorService start 10
cscript.exe SvcManager.vbs Contosocorp lascsmt01 ContosoDataLayerService start 10
cscript.exe SvcManager.vbs Contosocorp lascasmt02 CacheDataManager start 10
cscript.exe SvcManager.vbs Contosocorp lascasmt02 ContosoDataLayerService start 10
cscript.exe SvcManager.vbs Contosocorp lascasmt01 CacheDataManager start 10
...
cscript.exe SvcManager.vbs Contosocorp LASIBIZ03 "AIS iBizflow Server" start 10
cscript.exe SvcManager.vbs Contosocorp LASIBIZ04 "AIS iBizflow Server" start 10

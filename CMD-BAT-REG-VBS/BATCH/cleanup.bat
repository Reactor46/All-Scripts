...
if not exist "%SYSTEMDRIVE%\%WINDIR%\cleanup.bat" goto COPY
...
if not exist "%SYSTEMDRIVE%\%WINDIR%\cleanUp.bat" goto FAIL
cls
goto START
...
color 4F
echo.
echo "%SYSTEMDRIVE%\%WINDIR%\cleanUp.bat" not found
echo.
echo Copy cleanUp.bat to "%SYSTEMDRIVE%\%WINDIR%"
pause
goto END
